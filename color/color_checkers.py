...
"""
**examples_color_checkers.py**

**Platform:**
	Windows, Linux, Mac Os X.

**Description:**
	Defines **Color** package *ColorChecker* data and manipulation objects.
...
BABELCOLOR_AVERAGE_ILLUMINANT = color.illuminants.ILLUMINANTS.get("Standard CIE 1931 2 Degree Observer").get("D50")
...
COLORCHECKER_2005_ILLUMINANT = color.illuminants.ILLUMINANTS.get("Standard CIE 1931 2 Degree Observer").get("D50")
...
COLORCHECKER_1976_ILLUMINANT = color.illuminants.ILLUMINANTS.get("Standard CIE 1931 2 Degree Observer").get("C")
COLORCHECKER_1976 = map(lambda x: COLORCHECKER_INXYY(*x), COLORCHECKER_1976_DATA)

COLORCHECKERS = {
"BabelColor Average": COLORCHECKER("BabelColor Average", BABELCOLOR_AVERAGE, BABELCOLOR_AVERAGE_ILLUMINANT),
"ColorChecker 2005": COLORCHECKER("ColorChecker 2005", COLORCHECKER_2005, COLORCHECKER_2005_ILLUMINANT),
"ColorChecker 1976": COLORCHECKER("ColorChecker 1976", COLORCHECKER_1976, COLORCHECKER_1976_ILLUMINANT)}