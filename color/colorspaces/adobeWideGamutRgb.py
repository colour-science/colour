...
ADOBE_WIDE_GAMUT_RGB_TO_XYZ_MATRIX = color.derivation.getNormalizedPrimaryMatrix(ADOBE_WIDE_GAMUT_RGB_PRIMARIES,
																				 ADOBE_WIDE_GAMUT_RGB_WHITEPOINT)

XYZ_TO_ADOBE_WIDE_GAMUT_RGB_MATRIX = ADOBE_WIDE_GAMUT_RGB_TO_XYZ_MATRIX.getI()

def __adobeWideGamutRgbTransferFunction(RGB):
	"""
...
ADOBE_WIDE_GAMUT_RGB_INVERSE_TRANSFER_FUNCTION = __adobeWideGamutRgbInverseTransferFunction
