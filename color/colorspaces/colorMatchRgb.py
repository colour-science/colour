...
COLOR_MATCH_RGB_TO_XYZ_MATRIX = color.derivation.getNormalizedPrimaryMatrix(COLOR_MATCH_RGB_PRIMARIES,
																			COLOR_MATCH_RGB_WHITEPOINT)

XYZ_TO_COLOR_MATCH_RGB_MATRIX = COLOR_MATCH_RGB_TO_XYZ_MATRIX.getI()

def __colorMatchRgbTransferFunction(RGB):
	"""
...
def __colorMatchRgbInverseTransferFunction(RGB):
	"""
...
COLOR_MATCH_RGB_TRANSFER_FUNCTION = __colorMatchRgbTransferFunction

COLOR_MATCH_RGB_INVERSE_TRANSFER_FUNCTION = __colorMatchRgbInverseTransferFunction
