...
ECI_RGB_V2_WHITEPOINT = color.illuminants.ILLUMINANTS.get("CIE 1931 2 Degree Standard Observer").get("D50")
...
ECI_RGB_V2_TRANSFER_FUNCTION = lambda x: color.lightness.lightness_1976(x * 100.) / 100.

ECI_RGB_V2_INVERSE_TRANSFER_FUNCTION = lambda x: color.lightness.luminance_1976(x * 100.) / 100.
