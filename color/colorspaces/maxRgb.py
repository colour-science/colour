...
MAX_RGB_TO_XYZ_MATRIX = color.derivation.getNormalizedPrimaryMatrix(MAX_RGB_PRIMARIES, MAX_RGB_WHITEPOINT)

XYZ_TO_MAX_RGB_MATRIX = MAX_RGB_TO_XYZ_MATRIX.getI()

def __maxRgbTransferFunction(RGB):
	"""
...
def __maxRgbInverseTransferFunction(RGB):
	"""
...
MAX_RGB_TRANSFER_FUNCTION = __maxRgbTransferFunction

MAX_RGB_INVERSE_TRANSFER_FUNCTION = __maxRgbInverseTransferFunction
