...
NTSC_RGB_TO_XYZ_MATRIX = color.derivation.getNormalizedPrimaryMatrix(NTSC_RGB_PRIMARIES, NTSC_RGB_WHITEPOINT)

XYZ_TO_NTSC_RGB_MATRIX = NTSC_RGB_TO_XYZ_MATRIX.getI()

def __ntscRgbTransferFunction(RGB):
	"""
...
def __ntscRgbInverseTransferFunction(RGB):
	"""
...
NTSC_RGB_TRANSFER_FUNCTION = __ntscRgbTransferFunction

NTSC_RGB_INVERSE_TRANSFER_FUNCTION = __ntscRgbInverseTransferFunction
