...
PAL_SECAM_RGB_TO_XYZ_MATRIX = color.derivation.getNormalizedPrimaryMatrix(PAL_SECAM_RGB_PRIMARIES,
																		  PAL_SECAM_RGB_WHITEPOINT)

XYZ_TO_PAL_SECAM_RGB_MATRIX = PAL_SECAM_RGB_TO_XYZ_MATRIX.getI()

def __palSecamRgbTransferFunction(RGB):
	"""
...
def __palSecamRgbInverseTransferFunction(RGB):
	"""
...
PAL_SECAM_RGB_TRANSFER_FUNCTION = __palSecamRgbTransferFunction

PAL_SECAM_RGB_INVERSE_TRANSFER_FUNCTION = __palSecamRgbInverseTransferFunction
