...
SMPTE_C_RGB_TO_XYZ_MATRIX = color.derivation.getNormalizedPrimaryMatrix(SMPTE_C_RGB_PRIMARIES, SMPTE_C_RGB_WHITEPOINT)

XYZ_TO_SMPTE_C_RGB_MATRIX = SMPTE_C_RGB_TO_XYZ_MATRIX.getI()

def __smptecRgbTransferFunction(RGB):
	"""
...
def __smptecRgbInverseTransferFunction(RGB):
	"""
...
SMPTE_C_RGB_TRANSFER_FUNCTION = __smptecRgbTransferFunction

SMPTE_C_RGB_INVERSE_TRANSFER_FUNCTION = __smptecRgbInverseTransferFunction
