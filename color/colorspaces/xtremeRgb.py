...
XTREME_RGB_TO_XYZ_MATRIX = color.derivation.getNormalizedPrimaryMatrix(XTREME_RGB_PRIMARIES, XTREME_RGB_WHITEPOINT)

XYZ_TO_XTREME_RGB_MATRIX = XTREME_RGB_TO_XYZ_MATRIX.getI()

def __xtremeRgbTransferFunction(RGB):
	"""
...
def __xtremeRgbInverseTransferFunction(RGB):
	"""
...
XTREME_RGB_TRANSFER_FUNCTION = __xtremeRgbTransferFunction

XTREME_RGB_INVERSE_TRANSFER_FUNCTION = __xtremeRgbInverseTransferFunction
