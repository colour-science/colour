...
**Description:**
    Defines **Color** package *illuminants* relative spectral power distributions computation objects.
...
def D_illuminant_relative_spd(xy):
    ...
    Usage::
        ...
        <color.computation.SpectralPowerDistribution object at 0x101023590>
