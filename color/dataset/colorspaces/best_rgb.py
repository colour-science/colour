...
BEST_RGB_WHITEPOINT = color.dataset.illuminants.chromaticity_coordinates.ILLUMINANTS.get(
    "CIE 1931 2 Degree Standard Observer").get("D50")

BEST_RGB_TO_XYZ_MATRIX = color.computation.derivation.get_normalized_primary_matrix(BEST_RGB_PRIMARIES,
                                                                                     BEST_RGB_WHITEPOINT)
