...
__all__ = ["ILLUMINANTS_CIE_1931_2_DEGREE_STANDARD_OBSERVER_CHROMATICITY_COORDINATES",
...
ILLUMINANTS = {
    "CIE 1931 2 Degree Standard Observer": ILLUMINANTS_CIE_1931_2_DEGREE_STANDARD_OBSERVER_CHROMATICITY_COORDINATES,
    "CIE 1964 10 Degree Standard Observer": ILLUMINANTS_CIE_1964_10_DEGREE_STANDARD_OBSERVER_CHROMATICITY_COORDINATES}

# cmfs=color.STANDARD_OBSERVERS_CMFS.get("CIE 1931 2 Degree Standard Observer")
# for illuminant, spd in sorted(color.ILLUMINANTS_RELATIVE_SPDS.iteritems()):
# print illuminant, color.XYZ_to_xy(color.spectral_to_XYZ(spd, cmfs))
