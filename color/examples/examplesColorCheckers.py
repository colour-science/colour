...
"""
Shows some **Color** package *ColorChecker* related examples.
"""
...
# Displaying :attr:`color.colorCheckers.COLORCHECKERS` data.
...
for index, name, x, y, Y in data:
	RGB = color.xyY_to_RGB(matrix([[x], [y], [Y]]),
					 ...
					 "Bradford",
					 color.sRGB_COLORSPACE.fromXYZ,
					 color.sRGB_COLORSPACE.transferFunction)
