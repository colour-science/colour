...
print color.getMunsellValue(Y)
print color.getMunsellValue(Y, method="Munsell Value 1944")
...
print color.getLightness(Y)
print color.getLightness(Y, method="Lightness 1964")