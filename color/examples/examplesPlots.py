...
#**********************************************************************************************************************
singleColorPlot(colorParameter(name="Neutral 5 (.70 D)", RGB=(0.32315746, 0.32983556, 0.33640183)),
				textSize=32.)

#**********************************************************************************************************************
#***	Plotting multiples colors.
#**********************************************************************************************************************
multiColorPlot([colorParameter(name="Dark Skin", RGB=(0.45293517, 0.31732158, 0.26414773)),
				colorParameter(name="Light Skin", RGB=(0.77875824, 0.5772645, 0.50453169))],
			   spacing=0.,
			   textSize=32.)
...
colorCheckerPlot("ColorChecker 1976")
colorCheckerPlot("BabelColor Average",
				 displayText=False)
colorCheckerPlot("ColorChecker 1976",
				 displayText=False)
colorCheckerPlot("ColorChecker 2005",
				 displayText=False)

#**********************************************************************************************************************
#***	Plotting a single illuminant relative spectral power distribution.
#**********************************************************************************************************************
singleIlluminantRelativeSpdPlot("F1")
...
singleSpectralPowerDistributionPlot(color.SpectralPowerDistribution(name="Custom",
																	spd=sampleSpdData))

singleSpectralPowerDistributionPlot(color.SpectralPowerDistribution(name="Boron",
																	spd=boronSpd))

#**********************************************************************************************************************
#***	Plotting multiple relative spectral power distributions.
#**********************************************************************************************************************
multiSpectralPowerDistributionPlot([color.SpectralPowerDistribution(name="Boron",
																	spd=boronSpd),
...
singleColorMatchingFunctionsPlot("Standard CIE 1964 10 Degree Observer")
singleColorMatchingFunctionsPlot("Stiles & Burch 1955 2 Degree Observer",
								 legendLocation="upper left",
								 boundingBox=[390, 830, -0.5, 3.5])
singleColorMatchingFunctionsPlot("Stiles & Burch 1959 10 Degree Observer",
								 legendLocation="upper left",
								 boundingBox=[390, 830, -0.5, 3.5])
...
#**********************************************************************************************************************
multiColorMatchingFunctionsPlot(["Standard CIE 1931 2 Degree Observer",
								 "Standard CIE 1964 10 Degree Observer"])
multiColorMatchingFunctionsPlot(["Standard CIE 2006 10 Degree Observer",
								 "Standard CIE 1964 10 Degree Observer"])
multiColorMatchingFunctionsPlot(["Stiles & Burch 1955 2 Degree Observer",
...
colorspaces_CIE_1931_chromaticityDiagramPlot(["sRGB", "ACES RGB", "Adobe RGB 1998"])
...
#**********************************************************************************************************************
blackbodySpectralRadiancePlot(temperature=3500, blackbody="VY Canis Major")
blackbodySpectralRadiancePlot(temperature=5778, blackbody="The Sun")
blackbodySpectralRadiancePlot(temperature=12130, blackbody="Rigel")
...
blackbodySpd = color.blackbodySpectralPowerDistribution(5778, *ASTM_G_173_spd.shape)
blackbodySpd.name = "The Sun - 5778K"

multiSpectralPowerDistributionPlot([ASTM_G_173_spd, blackbodySpd],
								   yLabel=u"W / (sr m²) / m",
