...
print(color.uv_to_cct(uv, method="robertson", cmfs=cmfs, iterations=3))
...
# *Wyszecki & Roberston* calculation method.
print(color.cct_to_uv(6503.4925414981535, 0.0032059787171144823, method="robertson", cmfs=cmfs))
