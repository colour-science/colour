...
**Description:**
    Defines **Color** package data fitting objects.
...
__all__ = ["first_order_color_fit"]

LOGGER = color.utilities.verbose.install_logger()


def first_order_color_fit(m1, m2):
    """
    Performs a first order color fit from given *m2* color matrix to *m1* color matrix. The resulting color matrix is
    calculated using multiple linear regression.
    The purpose of that object is for example matching of two *ColorChecker* color rendition charts together.

    Usage::

        >>> m1 = numpy.array([[0.1722480953, 0.09170660377, 0.06416938454],
        ...
        >>> m2 = numpy.array([[0.1557955891, 0.09715754539, 0.07514556497],
        ...
        >>> first_order_color_fit(m1, m2)
        [[ 1.40431285  0.01128059 -0.20297103]
         [-0.09989111  1.50122142 -0.18564796]
         [ 0.22483693 -0.07672362  1.04960133]]

    :param m1: Reference matrix the matrix *m2* will be color fitted against.
    :type m1: matrix (3xn)
    :param m1: Matrix to fit.
    :type m1: matrix (3xn)
    :return: Fitting color matrix.
    :rtype: matrix (3x3)
    """

    x_coefficients = color.algebra.regression.linear_regression(m1[:, 0], m2)
    y_coefficients = color.algebra.regression.linear_regression(m1[:, 1], m2)
    z_coefficients = color.algebra.regression.linear_regression(m1[:, 2], m2)
