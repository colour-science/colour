...
**Description:**
	Defines **Color** package *spectral power distribution* data and manipulation objects.
...
STANDARD_OBSERVERS_COLOR_MATCHING_FUNCTIONS.update(STANDARD_OBSERVERS_XYZ_COLOR_MATCHING_FUNCTIONS)
