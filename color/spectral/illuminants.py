...
def D_illuminant_relative_spectral_power_distribution(xy):
    ...
    for i in numpy.arange(start, end + steps, steps):
        S0 = D_ILLUMINANTS_S_SPDS_DATA.get("S0").get(i)
        S1 = D_ILLUMINANTS_S_SPDS_DATA.get("S1").get(i)
        S2 = D_ILLUMINANTS_S_SPDS_DATA.get("S2").get(i)
...
__d60_illuminant_relative_spectral_power_distribution = D_illuminant_relative_spectral_power_distribution(
    (0.32168, 0.33767))
