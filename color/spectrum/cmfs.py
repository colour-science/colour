...
STANDARD_OBSERVERS_RGB_CMFS = {
    "Wright & Guild 1931 2 Degree Standard Observer": RGB_ColorMatchingFunctions("Wright & Guild 1931 2 Degree Standard Observer",
                                                                        STANDARD_OBSERVERS_RGB_CMFS_DATA.get(
                                                                            "Wright & Guild 1931 2 Degree Standard Observer")),
    "Stiles & Burch 1955 2 Degree Standard Observer": RGB_ColorMatchingFunctions("Stiles & Burch 1955 2 Degree Standard Observer",
                                                                        STANDARD_OBSERVERS_RGB_CMFS_DATA.get(
                                                                            "Stiles & Burch 1955 2 Degree Standard Observer")),
    "Stiles & Burch 1959 10 Degree Standard Observer": RGB_ColorMatchingFunctions("Stiles & Burch 1959 10 Degree Standard Observer",
                                                                         STANDARD_OBSERVERS_RGB_CMFS_DATA.get(
                                                                             "Stiles & Burch 1959 10 Degree Standard Observer")),
}
