...
CIE_RGB_CMFS = {
    "Wright & Guild 1931 2 Degree RGB CMFs": RGB_ColorMatchingFunctions(
        "Wright & Guild 1931 2 Degree RGB CMFs",
        CIE_RGB_CMFS_DATA.get("Wright & Guild 1931 2 Degree RGB CMFs")),
    "Stiles & Burch 1955 2 Degree RGB CMFs": RGB_ColorMatchingFunctions(
        "Stiles & Burch 1955 2 Degree RGB CMFs",
        CIE_RGB_CMFS_DATA.get("Stiles & Burch 1955 2 Degree RGB CMFs")),
    "Stiles & Burch 1959 10 Degree RGB CMFs": RGB_ColorMatchingFunctions(
        "Stiles & Burch 1959 10 Degree RGB CMFs",
        CIE_RGB_CMFS_DATA.get("Stiles & Burch 1959 10 Degree RGB CMFs"))}
...
STANDARD_OBSERVERS_CMFS = {
    ...
    "CIE 1964 10 Degree Standard Observer": XYZ_ColorMatchingFunctions("CIE 1964 10 Degree Standard Observer",
                                                                       STANDARD_OBSERVERS_CMFS_DATA.get(
                                                                           "CIE 1964 10 Degree Standard Observer")),
    "CIE 2012 2 Degree Standard Observer": XYZ_ColorMatchingFunctions("CIE 2012 2 Degree Standard Observer",
                                                                      STANDARD_OBSERVERS_CMFS_DATA.get(
                                                                          "CIE 2012 2 Degree Standard Observer")),
    "CIE 2012 10 Degree Standard Observer": XYZ_ColorMatchingFunctions("CIE 2012 10 Degree Standard Observer",
                                                                       STANDARD_OBSERVERS_CMFS_DATA.get(
                                                                           "CIE 2012 10 Degree Standard Observer"))}

CMFS = dict(CIE_RGB_CMFS)
