...
"""
**testsChromaticAdaptation.py**

**Platform:**
	Windows, Linux, Mac Os X.

**Description:**
	Defines units tests for :mod:`color.chromaticAdaptation` module.
...
class GetChromaticAdaptationMatrixTestCase(unittest.TestCase):
	"""
	Defines :func:`color.chromaticAdaptation.getChromaticAdaptationMatrix` definition units tests methods.
	"""

	def testGetChromaticAdaptationMatrix(self):
		"""
		Tests :func:`color.chromaticAdaptation.getChromaticAdaptationMatrix` definition.
		"""

		numpy.testing.assert_almost_equal(
			color.chromaticAdaptation.getChromaticAdaptationMatrix(numpy.matrix([1.09923822,
																				 1.000,
		...
		numpy.testing.assert_almost_equal(
			color.chromaticAdaptation.getChromaticAdaptationMatrix(numpy.matrix([1.92001986,
																				 1.,
		...
		numpy.testing.assert_almost_equal(
			color.chromaticAdaptation.getChromaticAdaptationMatrix(numpy.matrix([1.92001986,
																   ...
																   numpy.matrix([1.0131677,
																				 1.000,
																				 2.11217686]).reshape((3, 1)), ),
			color.chromaticAdaptation.getChromaticAdaptationMatrix(numpy.matrix([1.0131677,
																				 1.000,
																				 2.11217686]).reshape((3, 1)),
	...
	numpy.testing.assert_almost_equal(
		color.chromaticAdaptation.getChromaticAdaptationMatrix(numpy.matrix([1.09850,
																			 1.00000,
																			 0.35585]).reshape((3, 1)),
