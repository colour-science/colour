...
**Description:**
    Defines units tests for :mod:`color.computation.correction` module.
...
import color.computation.correction
...
class TestBandpassCorrectionStearns(unittest.TestCase):
    """
    Defines :func:`color.computation.correction.bandpass_correction_stearns` definition units tests methods.
    """

    def test_bandpass_correction_stearns(self):
        """
        Tests :func:`color.computation.correction.bandpass_correction_stearns` definition.
        """
        ...
        numpy.testing.assert_almost_equal(BANDPASS_CORRECTED_STEARNS_SPD_DATA,
                                          color.computation.correction.bandpass_correction_stearns(spd).values)
