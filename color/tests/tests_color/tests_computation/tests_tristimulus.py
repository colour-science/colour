...
**Description:**
    Defines units tests for :mod:`color.computation.tristimulus` module.
...
RELATIVE_SPD_DATA = color.computation.spectrum.SpectralPowerDistribution("Custom", {
    340: 0.0000,
    345: 0.0000,
    350: 0.0000,
    355: 0.0000,
...
class TestSpectral_to_XYZ(unittest.TestCase):
    """
    Defines :func:`color.computation.tristimulus.spectral_to_XYZ` definition units tests methods.
    """
...
class TestWavelength_to_XYZ(unittest.TestCase):
    """
    Defines :func:`color.computation.tristimulus.wavelength_to_XYZ` definition units tests methods.
    """

    def test_wavelength_to_XYZ(self):
        """
        Tests :func:`color.computation.tristimulus.wavelength_to_XYZ` definition.
        """
