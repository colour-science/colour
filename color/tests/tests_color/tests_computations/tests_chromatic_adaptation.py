...
**Description:**
    Defines units tests for :mod:`color.computation.chromatic_adaptation` module.
...
class TestGetChromaticAdaptationMatrix(unittest.TestCase):
    """
    Defines :func:`color.computation.chromatic_adaptation.get_chromatic_adaptation_matrix` definition units tests methods.
    """

    def test_get_chromatic_adaptation_matrix(self):
        """
        Tests :func:`color.computation.chromatic_adaptation.get_chromatic_adaptation_matrix` definition.
        """

        numpy.testing.assert_almost_equal(
            color.computation.chromatic_adaptation.get_chromatic_adaptation_matrix(numpy.matrix([1.09923822,
                                                                                                  1.000,
                                                                                                  0.35445412]).reshape(
                (3, 1)),
        ...
        numpy.testing.assert_almost_equal(
            color.computation.chromatic_adaptation.get_chromatic_adaptation_matrix(numpy.matrix([1.92001986,
                                                                                                  1.,
                                                                                                  -0.1241347]).reshape(
                (3, 1)),
            ...
            color.computation.chromatic_adaptation.get_chromatic_adaptation_matrix(numpy.matrix([1.92001986,
                ...
                (3, 1)),
                                                                                    numpy.matrix([1.0131677,
                                                                                                  ...
                                                                                                  2.11217686]).reshape(
                                                                                        (3, 1)), ),
            color.computation.chromatic_adaptation.get_chromatic_adaptation_matrix(numpy.matrix([1.0131677,
                                                                                                  1.000,
                                                                                                  2.11217686]).reshape(
                (3, 1)),
    ...
    numpy.testing.assert_almost_equal(
        color.computation.chromatic_adaptation.get_chromatic_adaptation_matrix(numpy.matrix([1.09850,
                                                                                              1.00000,
                                                                                              0.35585]).reshape((3, 1)),
