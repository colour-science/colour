...
**Description:**
    Defines units tests for :mod:`color.computation.illuminants` module.
...
class TestD_illuminantRelativeSpd(unittest.TestCase):
    """
    Defines :func:`color.computation.illuminants.D_illuminant_relative_spd` definition units tests methods.
    """

    def test_D_illuminant_relative_spd(self):
        """
        Tests :func:`color.computation.illuminants.D_illuminant_relative_spd` definition.
        """
