...
D60_SPD_DATA = {300: 0.029370758174922885,
...
class D_illuminantRelativeSpectralPowerDistributionTestCase(unittest.TestCase):
	...
	def test_D_illuminant_relative_spectral_power_distribution(self):
		"""
		Tests :func:`color.spectral.D_illuminant_relative_spectral_power_distribution` definition.
		"""

		numpy.testing.assert_almost_equal(sorted(color.spectral.D_illuminant_relative_spectral_power_distribution((0.32168, 0.33767)).spd.values()),
