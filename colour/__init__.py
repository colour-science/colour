...
from .colorimetry import (
    ...
    spd_blackbody, spd_constant, spd_gaussian, spd_ones, spd_zeros,
...
__all__ += [
    ...
    'mesopic_luminous_efficiency_function', 'single_led_spd',
    'spd_CIE_illuminant_D_series', 'spd_blackbody', 'spd_constant',
    'spd_gaussian', 'spd_ones', 'spd_zeros', 'spectral_to_XYZ',
