...
cartesian_to_spherical` definition n-dimensional arrays support.
        ...
        a_i = np.tile(a_i, (6, 1))
        a_o = np.tile(a_o, (6, 1))
        np.testing.assert_almost_equal(cartesian_to_spherical(a_i), a_o, decimal=7)
...
spherical_to_cartesian` definition n-dimensional arrays support.
        ...
        a_i = np.tile(a_i, (6, 1))
        a_o = np.tile(a_o, (6, 1))
        np.testing.assert_almost_equal(spherical_to_cartesian(a_i), a_o, decimal=7)
...
cartesian_to_cylindrical` definition n-dimensional arrays support.
        ...
        a_i = np.tile(a_i, (6, 1))
        a_o = np.tile(a_o, (6, 1))
        np.testing.assert_almost_equal(cartesian_to_cylindrical(a_i), a_o, decimal=7)
...
cylindrical_to_cartesian` definition n-dimensional arrays support.
        ...
        a_i = np.tile(a_i, (6, 1))
        a_o = np.tile(a_o, (6, 1))
        np.testing.assert_almost_equal(cylindrical_to_cartesian(a_i), a_o, decimal=7)
