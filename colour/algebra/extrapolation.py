...
class Extrapolator1d(object):
    ...
    def interpolator(self, value):
        ...
        if value is not None:
            assert hasattr(value, "x"), "'{0}' attribute has no 'x' attribute!".format("interpolator", value)
            assert hasattr(value, "y"), "'{0}' attribute has no 'y' attribute!".format("interpolator", value)
