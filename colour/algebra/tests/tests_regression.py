...
class TestLinearRegression(unittest.TestCase):
    ...
    def test_linear_regression(self):
        ...
        numpy.testing.assert_almost_equal(colour.algebra.regression.linear_regression(Y),
                                          [0.1406015, 1.77368421],
                                          decimal=7)
        numpy.testing.assert_almost_equal(colour.algebra.regression.linear_regression(Y, X1),
                                          [0.12777065, -3.38129694],
                                          decimal=7)
        numpy.testing.assert_almost_equal(colour.algebra.regression.linear_regression(Y, zip(X1, X2)),
