...
def XYZ_to_sCAM(
    ...
    *CIE XYZ* tristimulus values.
    ...
    +==============================+=======================+===============+
    | ``CAM_Specification_sCAM.J`` | [0, 100]              | [0, 1]        |
    +------------------------------+-----------------------+---------------+
    | ``CAM_Specification_sCAM.C`` | [0, 100]              | [0, 1]        |
    +------------------------------+-----------------------+---------------+
    | ``CAM_Specification_sCAM.h`` | [0, 360]              | [0, 1]        |
    +------------------------------+-----------------------+---------------+
    | ``CAM_Specification_sCAM.Q`` | [0, 100]              | [0, 1]        |
    +------------------------------+-----------------------+---------------+
    | ``CAM_Specification_sCAM.M`` | [0, 100]              | [0, 1]        |
    +------------------------------+-----------------------+---------------+
    | ``CAM_Specification_sCAM.H`` | [0, 400]              | [0, 1]        |
    +------------------------------+-----------------------+---------------+
    | ``CAM_Specification_sCAM.HC``| None                  | None          |
    +------------------------------+-----------------------+---------------+
    | ``CAM_Specification_sCAM.V`` | [0, 100]              | [0, 1]        |
    +------------------------------+-----------------------+---------------+
    | ``CAM_Specification_sCAM.K`` | [0, 100]              | [0, 1]        |
    +------------------------------+-----------------------+---------------+
    | ``CAM_Specification_sCAM.W`` | [0, 100]              | [0, 1]        |
    +------------------------------+-----------------------+---------------+
    | ``CAM_Specification_sCAM.D`` | [0, 100]              | [0, 1]        |
    +------------------------------+-----------------------+---------------+
