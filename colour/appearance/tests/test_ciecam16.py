...
class TestXYZ_to_CIECAM16:
    ...
    def test_XYZ_to_CIECAM16(self, xp: ModuleType) -> None:
        ...
        xp_assert_close(
            XYZ_to_CIECAM16(XYZ, XYZ_w, L_A, Y_b, surround, compute_H=True),
            [
                41.73120791,
                0.10335574,
                217.06795977,
        ...
        XYZ = xp_as_array([60.70, 49.60, 10.29], xp=xp)
        XYZ_w = xp_as_array([96.46, 100.00, 108.62], xp=xp)
        L_A = 40
        Y_b = 16
        xp_assert_close(
            XYZ_to_CIECAM16(XYZ, XYZ_w, L_A, Y_b, surround, compute_H=True),
    ...
    def test_n_dimensional_XYZ_to_CIECAM16(self, xp: ModuleType) -> None:
        ...
        Y_b = 20
        surround = VIEWING_CONDITIONS_CIECAM16["Average"]
        specification = XYZ_to_CIECAM16(XYZ, XYZ_w, L_A, Y_b, surround, compute_H=True)
...
class TestCIECAM16_to_XYZ:
    ...
    def test_n_dimensional_CIECAM16_to_XYZ(self, xp: ModuleType) -> None:
        ...
        surround = VIEWING_CONDITIONS_CIECAM16["Average"]
        specification = XYZ_to_CIECAM16(XYZ, XYZ_w, L_A, Y_b, surround, compute_H=True)
        XYZ = as_ndarray(CIECAM16_to_XYZ(specification, XYZ_w, L_A, Y_b, surround))
    ...
    def test_raise_exception_CIECAM16_to_XYZ(self) -> None:
        ...
        with pytest.raises(ValueError):
            CIECAM16_to_XYZ(
                CAM_Specification_CIECAM16(41.73120790512664, None, 217.067959767393),
