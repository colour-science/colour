...
COLORCHECKER_2005_DATA = (
    ...
    (3, 'blue sky', 0.2760, 0.3016, 0.1836),
    ...
    (18, 'cyan', 0.2131, 0.3023, 0.1930),
    (19, 'white 9.5 (.05 D)', 0.3469, 0.3608, 0.9131),
    (20, 'neutral 8 (.23 D)', 0.3440, 0.3584, 0.5894),
...
COLORCHECKER_1976_DATA = (
    ...
    (3, 'blue sky', 0.2470, 0.2514, 0.1933),
    (4, 'foliage', 0.3372, 0.4220, 0.1329),
    (5, 'blue flower', 0.2651, 0.2400, 0.2427),
    (6, 'bluish green', 0.2608, 0.3430, 0.4306),
    (7, 'orange', 0.5060, 0.4070, 0.3005),
    (8, 'purplish blue', 0.2110, 0.1750, 0.1200),
    (9, 'moderate red', 0.4533, 0.3058, 0.1977),
    (10, 'purple', 0.2845, 0.2020, 0.0656),
    (11, 'yellow green', 0.3800, 0.4887, 0.4429),
    (12, 'orange yellow', 0.4729, 0.4375, 0.4306),
    (13, 'blue', 0.1866, 0.1285, 0.0611),
    (14, 'green', 0.3046, 0.4782, 0.2339),
    (15, 'red', 0.5385, 0.3129, 0.1200),
    (16, 'yellow', 0.4480, 0.4703, 0.5910),
    (17, 'magenta', 0.3635, 0.2325, 0.1977),
    (18, 'cyan', 0.1958, 0.2519, 0.1977),
    (19, 'white 9.5 (.05 D)', 0.3101, 0.3163, 0.9001),
    (20, 'neutral 8 (.23 D)', 0.3101, 0.3163, 0.5910),
    (21, 'neutral 6.5 (.44 D)', 0.3101, 0.3163, 0.3620),
    (22, 'neutral 5 (.70 D)', 0.3101, 0.3163, 0.1977),
    (23, 'neutral 3.5 (1.05 D)', 0.3101, 0.3163, 0.0900),
