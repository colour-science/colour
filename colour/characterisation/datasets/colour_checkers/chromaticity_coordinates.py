...
DATA_BABELCOLOR_AVERAGE: dict = {
    ...
    for label, data in zip(
        SAMPLE_LABELS_COLORCHECKER_CLASSIC,
        [
            [0.4325, 0.3788, 0.1034],
            [0.4191, 0.3748, 0.3525],
            [0.2761, 0.3004, 0.1847],
            [0.3700, 0.4501, 0.1335],
            [0.3020, 0.2877, 0.2324],
            [0.2856, 0.3910, 0.4174],
            [0.5291, 0.4075, 0.3117],
            [0.2339, 0.2155, 0.1140],
            [0.5008, 0.3293, 0.1979],
            [0.3326, 0.2556, 0.0644],
            [0.3989, 0.4998, 0.4435],
            [0.4962, 0.4428, 0.4358],
            [0.2040, 0.1696, 0.0579],
            [0.3270, 0.5033, 0.2307],
            [0.5709, 0.3298, 0.1268],
            [0.4694, 0.4732, 0.6081],
            [0.4177, 0.2704, 0.2007],
            [0.2151, 0.3037, 0.1903],
            [0.3488, 0.3628, 0.9129],
            [0.3451, 0.3596, 0.5885],
            [0.3446, 0.3590, 0.3595],
            [0.3438, 0.3589, 0.1912],
            [0.3423, 0.3576, 0.0893],
            [0.3439, 0.3565, 0.0320],
        ],
        strict=True,
    )
}
...
DATA_COLORCHECKER24_BEFORE_NOV2014_CIE_LAB: dict = {
    label: np.array(data)
    for label, data in zip(
        SAMPLE_LABELS_COLORCHECKER_CLASSIC,
        [
...
DATA_COLORCHECKERSG_BEFORE_NOV2014_CIE_LAB: dict = {
    label: np.array(data)
    for label, data in zip(
        SAMPLE_LABELS_COLORCHECKER_SG,
        [
...
DATA_COLORCHECKERSG_AFTER_NOV2014_CIE_LAB: dict = {
    label: np.array(data)
    for label, data in zip(
        SAMPLE_LABELS_COLORCHECKER_SG,
        [
...
DATA_TE226_V2_CIE_XYZ: dict = {
    label: np.array(data)
    for label, data in {
        "dark skin": [0.1278, 0.1074, 0.0726],
        "light skin": [0.4945, 0.4484, 0.3586],
        "blue sky": [0.1459, 0.1690, 0.2925],
        "foliage": [0.0714, 0.1243, 0.0254],
        "blue flower": [0.4470, 0.4039, 0.7304],
        "bluish green": [0.3921, 0.5420, 0.6113],
        "orange": [0.4574, 0.3628, 0.0624],
        "purplish blue": [0.2979, 0.3180, 0.8481],
        "moderate red": [0.3884, 0.2794, 0.1886],
        "purple": [0.1324, 0.0796, 0.3824],
        "yellow green": [0.3399, 0.5786, 0.1360],
        "orange yellow": [0.5417, 0.4677, 0.0644],
        "blue": [0.0859, 0.0361, 0.4728],
        "green": [0.1000, 0.2297, 0.0530],
        "red": [0.3594, 0.1796, 0.0197],
        "yellow": [0.5236, 0.5972, 0.0368],
        "magenta": [0.4253, 0.2050, 0.5369],
        "cyan": [0.4942, 0.6119, 1.0304],
        "patch 19": [0.2646, 0.2542, 0.1631],
        "patch 20": [0.7921, 0.7560, 0.5988],
        "patch 21": [0.4409, 0.4004, 0.3366],
        "patch 22": [0.1546, 0.3395, 0.1016],
        "patch 23": [0.3182, 0.3950, 0.5857],
        "patch 24": [0.5920, 0.5751, 0.9892],
        "patch 25": [0.4287, 0.2583, 0.0444],
        "patch 26": [0.4282, 0.5757, 0.4770],
        "patch 27": [0.1697, 0.1294, 0.7026],
        "patch 28": [0.2143, 0.1564, 0.1908],
        "patch 29": [0.1659, 0.3876, 0.3945],
        "patch 30": [0.1869, 0.1093, 0.7069],
        "patch 31": [0.3316, 0.1596, 0.1714],
        "patch 32": [0.8298, 0.8910, 0.5199],
        "patch 33": [0.1412, 0.1758, 0.4643],
        "patch 34": [0.0153, 0.0668, 0.0694],
        "patch 35": [0.6053, 0.5088, 0.1593],
        "patch 36": [0.4217, 0.4459, 0.3173],
        "white": [0.9505, 1.0000, 1.0888],
        "neutral 87": [0.8331, 0.8801, 0.9576],
        "neutral 63": [0.6050, 0.6401, 0.6958],
        "neutral 44": [0.4119, 0.4358, 0.4724],
        "neutral 28": [0.2638, 0.2798, 0.3018],
        "neutral 15": [0.1405, 0.1489, 0.1598],
