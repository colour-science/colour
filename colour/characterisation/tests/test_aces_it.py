...
sd_to_aces_relative_exposure_values` definition.
        ...
        xp_assert_close(
            ...
            [0.97783784, 0.97783784, 0.97783784],
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            ...
            [0.11807796, 0.08690312, 0.05891252],
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            sd_to_aces_relative_exposure_values(dark_skin, SDS_ILLUMINANTS["A"]),
            [0.12937082, 0.09120875, 0.06110636],
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            ...
            [0.11805993, 0.08689013, 0.05900396],
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
class TestWhiteBalanceMultipliers:
    ...
    def test_white_balance_multipliers(self) -> None:
        ...
        xp_assert_close(
            ...
            [2.34141541, 1.00000000, 1.51633759],
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
        ...
        xp_assert_close(
            ...
            [1.57095278, 1.00000000, 2.43560477],
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
...
class TestWhitepointPreservingMatrix:
    ...
    def test_whitepoint_preserving_matrix(self, xp: ModuleType) -> None:
        """
        Test :func:`colour.characterisation.aces_it.\
whitepoint_preserving_matrix` definition.
        ...
        xp_assert_equal(
            whitepoint_preserving_matrix(xp_reshape(xp.arange(9), (3, 3), xp=xp)),
            [[0, 1, 0], [3, 4, -6], [6, 7, -12]],
        )

        xp_assert_equal(
            whitepoint_preserving_matrix(xp_reshape(xp.arange(12), (3, 4), xp=xp)),
            [[0, 1, 2, -2], [4, 5, 6, -14], [8, 9, 10, -26]],
        )

        xp_assert_equal(
            whitepoint_preserving_matrix(
                xp_reshape(xp.arange(9), (3, 3), xp=xp),
                xp_as_array([1, 2, 3], xp=xp),
            ),
            [[0, 1, 0], [3, 4, -5], [6, 7, -10]],
        )
...
class TestCamera_RGB_to_ACES2065_1:
    ...
    def test_camera_RGB_to_ACES2065_1(self, xp: ModuleType) -> None:
        """
        ...
        xp_assert_close(
            camera_RGB_to_ACES2065_1(xp_as_array([0.1, 0.2, 0.3], xp=xp), B, b),
            [0.27064400, 0.15614871, 0.50129650],
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            camera_RGB_to_ACES2065_1(xp_as_array([1.5, 1.5, 1.5], xp=xp), B, b),
            [3.36538176, 1.47467189, 2.46068761],
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )

        xp_assert_close(
            camera_RGB_to_ACES2065_1(xp_as_array([1.0, 1.0, 1.0], xp=xp), B, b, True),
            [2.24358784, 0.98311459, 1.64045840],
            atol=TOLERANCE_ABSOLUTE_TESTS,
        )
