...
class LMS_ConeFundamentals(MultiSpectralDistribution):
    """
...
class RGB_ColourMatchingFunctions(MultiSpectralDistribution):
    """
...
class XYZ_ColourMatchingFunctions(MultiSpectralDistribution):
    """
