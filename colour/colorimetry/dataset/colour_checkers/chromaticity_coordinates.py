...
BABELCOLOR_AVERAGE_ILLUMINANT = colour.colorimetry.dataset.illuminants.chromaticity_coordinates.ILLUMINANTS.get(
    "CIE 1931 2 Degree Standard Observer").get("D50")
BABELCOLOR_AVERAGE = map(lambda x: COLOURCHECKER_INXYY(*x), BABELCOLOR_AVERAGE_DATA)

COLORCHECKER_2005_DATA = ((1, "dark skin", 0.4316, 0.3777, 0.1008),
...
COLORCHECKER_2005_ILLUMINANT = colour.colorimetry.dataset.illuminants.chromaticity_coordinates.ILLUMINANTS.get(
    "CIE 1931 2 Degree Standard Observer").get("D50")
COLORCHECKER_2005 = map(lambda x: COLOURCHECKER_INXYY(*x), COLORCHECKER_2005_DATA)

COLORCHECKER_1976_DATA = ((1, "dark skin", 0.4002, 0.3504, 0.1005),
...
COLORCHECKER_1976_ILLUMINANT = colour.colorimetry.dataset.illuminants.chromaticity_coordinates.ILLUMINANTS.get(
    "CIE 1931 2 Degree Standard Observer").get("C")
COLORCHECKER_1976 = map(lambda x: COLOURCHECKER_INXYY(*x), COLORCHECKER_1976_DATA)

COLOURCHECKERS = {
    "BabelColor Average": COLOURCHECKER("BabelColor Average", BABELCOLOR_AVERAGE, BABELCOLOR_AVERAGE_ILLUMINANT),
    "ColorChecker 2005": COLOURCHECKER("ColorChecker 2005", COLORCHECKER_2005, COLORCHECKER_2005_ILLUMINANT),
