...
**Description:**
    Defines **Colour** package *MacAdam* optimal colour stimuli for various illuminants in *CIE xyY* colourspace.
...
# **David MacAdam**. *Maximum Visual Efficiency of Colored Materials* JOSA, Vol. 25, Pages 361, 367
C_OPTIMAL_COLOUR_STIMULI = (
    (0.0000, 0.0000, 0),
    (0.1363, 0.0692, 10),
    (0.1308, 0.0792, 10),
