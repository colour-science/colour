...
__all__ = [
    ...
    'LIGHT_SOURCES_NIST_PHILIPS_SDS', 'LIGHT_SOURCES_COMMON_SDS_DATA',
    'LIGHT_SOURCES_COMMON_SDS', 'LIGHT_SOURCES_SDS'
]
...
LIGHT_SOURCES_COMMON_SDS = CaseInsensitiveMapping({
    'Kinoton 75P':
        SpectralDistribution(
            LIGHT_SOURCES_COMMON_SDS_DATA['Kinoton 75P'], name='Kinoton 75P')
})
"""
Projectors and Xenon Arc Lamps.
...
LIGHT_SOURCES_SDS.update(LIGHT_SOURCES_COMMON_SDS)
