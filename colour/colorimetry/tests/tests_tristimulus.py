...
RELATIVE_SPD_DATA = colour.colorimetry.spectrum.SpectralPowerDistribution("Custom", {
    340: 0.0000,
    345: 0.0000,
    350: 0.0000,
    355: 0.0000,
...
class TestSpectral_to_XYZ(unittest.TestCase):
    """
    Defines :func:`colour.colorimetry.tristimulus.spectral_to_XYZ` definition units tests methods.
    """

    def test_spectral_to_XYZ(self):
        """
        Tests :func:`colour.colorimetry.tristimulus.spectral_to_XYZ` definition.
        """
...
class TestWavelength_to_XYZ(unittest.TestCase):
    """
    Defines :func:`colour.colorimetry.tristimulus.wavelength_to_XYZ` definition units tests methods.
    """
