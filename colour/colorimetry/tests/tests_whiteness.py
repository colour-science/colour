...
class TestWhitenessASTM313(unittest.TestCase):
    """
    Defines :func:`colour.colorimetry.whiteness.whiteness_ASTM_313`
    definition unit tests methods.
    """

    def test_whiteness_ASTM_313(self):
        """
        Tests :func:`colour.colorimetry.whiteness.whiteness_ASTM_313`
        definition.
        """
