...
**Description:**
    Defines units tests for :mod:`colour.computation.correction` module.
...
import colour.computation.correction
...
class TestBandpassCorrectionStearns(unittest.TestCase):
    """
    Defines :func:`colour.computation.correction.bandpass_correction_stearns` definition units tests methods.
    """

    def test_bandpass_correction_stearns(self):
        """
        Tests :func:`colour.computation.correction.bandpass_correction_stearns` definition.
        """
        ...
        numpy.testing.assert_almost_equal(BANDPASS_CORRECTED_STEARNS_SPD_DATA,
                                          colour.computation.correction.bandpass_correction_stearns(spd).values)
