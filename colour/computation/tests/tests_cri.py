...
**Description:**
    Defines units tests for :mod:`colour.computation.cri` module.
...
class TestGetColourRenderingIndex(unittest.TestCase):
    ...
    def test_xy_to_z(self):
        ...
        self.assertAlmostEqual(
            colour.computation.cri.get_colour_rendering_index(
                colour.dataset.illuminants.spds.ILLUMINANTS_RELATIVE_SPDS.get("F2")),
            64.1507331494,
            places=7)

        self.assertAlmostEqual(
            colour.computation.cri.get_colour_rendering_index(
                colour.dataset.illuminants.spds.ILLUMINANTS_RELATIVE_SPDS.get("A")),
            99.9978916846,
            places=7)
