...
**Description:**
    Defines units tests for :mod:`colour.computation.luminance` module.
...
class TestLuminance1976(unittest.TestCase):
    """
    Defines :func:`colour.computation.luminance.luminance_1976` definition units tests methods.
    """

    def test_luminance_1976(self):
        """
        Tests :func:`colour.computation.luminance.luminance_1976` definition.
        """

        self.assertAlmostEqual(colour.computation.luminance.luminance_1976(37.9856290977, 100.), 10.08, places=7)
        self.assertAlmostEqual(colour.computation.luminance.luminance_1976(80.0444155585, 100.), 56.76, places=7)
        self.assertAlmostEqual(colour.computation.luminance.luminance_1976(99.3467279026, 100.), 98.32, places=7)


class TestLuminanceASTM_D1535_08(unittest.TestCase):
    """
    Defines :func:`colour.computation.luminance.luminance_ASTM_D1535_08` definition units tests methods.
    """
