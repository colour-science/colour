...
BABELCOLOR_AVERAGE_ILLUMINANT = colour.dataset.illuminants.chromaticity_coordinates.ILLUMINANTS.get(
...
COLORCHECKER_2005_ILLUMINANT = colour.dataset.illuminants.chromaticity_coordinates.ILLUMINANTS.get(
    "CIE 1931 2 Degree Standard Observer").get("D50")
...
COLORCHECKER_1976_ILLUMINANT = colour.dataset.illuminants.chromaticity_coordinates.ILLUMINANTS.get(
