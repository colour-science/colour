...
ACES_RGB_PRIMARIES = numpy.array([0.73470, 0.26530,
                                  0.00000, 1.00000,
                                  0.00010, -0.07700]).reshape((3, 2))

ACES_RGB_WHITEPOINT = colour.dataset.illuminants.chromaticity_coordinates.ILLUMINANTS.get(
...
ACES_RGB_TO_XYZ_MATRIX = numpy.array([9.52552396e-01, 0.00000000e+00, 9.36786317e-05,
                                      3.43966450e-01, 7.28166097e-01, -7.21325464e-02,
                                      0.00000000e+00, 0.00000000e+00, 1.00882518e+00]).reshape((3, 3))

XYZ_TO_ACES_RGB_MATRIX = numpy.linalg.inv(ACES_RGB_TO_XYZ_MATRIX)
...
ACES_RGB_PROXY_12_CONSTANTS = colour.utilities.data_structures.Structure(CV_min=0.,
                                                                         CV_max=4095.,
                                                                         steps_per_stop=200.,
                                                                         mid_CV_offset=1700.,
                                                                         mid_log_offset=-2.5)
