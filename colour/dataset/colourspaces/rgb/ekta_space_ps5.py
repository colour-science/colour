...
EKTA_SPACE_PS_5_PRIMARIES = numpy.array([0.6947368421052631, 0.30526315789473685,
...
EKTA_SPACE_PS_5_TO_XYZ_MATRIX = colour.computation.colourspaces.rgb.derivation.get_normalised_primary_matrix(
    EKTA_SPACE_PS_5_PRIMARIES,
    EKTA_SPACE_PS_5_WHITEPOINT)

XYZ_TO_EKTA_SPACE_PS_5_MATRIX = numpy.linalg.inv(EKTA_SPACE_PS_5_TO_XYZ_MATRIX)
