...
**Description:**
    Defines **Colour** package *CIE 1995* test colour samples spectral power distributions.
...
TCS_SPDS = dict((key, SpectralPowerDistribution(key, value)) for key, value in TCS_SPDS_DATA.iteritems())