...
L_A2 = 200
message_box(
    f'Computing chromatic adaptation using "CMCCAT200" forward chromatic adaptation model.\n\n\t"XYZ":\n\t\t{XYZ}\n\t"XYZ_w":\n\t\t{XYZ_w}\n\t"XYZ_wr":\n\t\t{XYZ_wr}\n\t"L_A1":\n\t\t{L_A1}\n\t"L_A2":\n\t\t{L_A2}'
)
print(
...
message_box(
    f'Computing chromatic adaptation using "CMCCAT200" inverse chromatic adaptation model.\n\n\t"XYZ_c":\n\t\t{XYZ_c}\n\t"XYZ_w":\n\t\t{XYZ_w}\n\t"XYZ_wr":\n\t\t{XYZ_wr}\n\t"L_A1":\n\t\t{L_A1}\n\t"L_A2":\n\t\t{L_A2}'
)
print(
    colour.chromatic_adaptation(
        XYZ_c,
