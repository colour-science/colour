"""Showcases *CIECAM16* colour appearance model computations."""
...
specification = colour.XYZ_to_CIECAM16(XYZ, XYZ_w, L_A, Y_b, surround)
print(specification)
...
print(colour.CIECAM16_to_XYZ(specification, XYZ_w, L_A, Y_b, surround))
