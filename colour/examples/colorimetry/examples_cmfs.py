...
message_box(('Converting from "Wright & Guild 1931 2 Degree RGB CMFs" colour '
             ...
             'wavelength 700 nm.'))
print(
    colour.STANDARD_OBSERVER_CMFS['CIE 1931 2 Degree Standard Observer'][700])
...
message_box(('Converting from "Stiles & Burch 1959 10 Degree RGB CMFs" colour '
             ...
             'wavelength 700 nm.'))
print(
    colour.STANDARD_OBSERVER_CMFS['CIE 1964 10 Degree Standard Observer'][700])
...
message_box(('Converting from "Stockman & Sharpe 2 Degree Cone Fundamentals" '
             ...
             'functions at wavelength 700 nm.'))
print(
    colour.STANDARD_OBSERVER_CMFS['CIE 2012 2 Degree Standard Observer'][700])
...
message_box(('Converting from "Stockman & Sharpe 10 Degree Cone Fundamentals" '
             ...
             'functions at wavelength 700 nm.'))
print(
    colour.STANDARD_OBSERVER_CMFS['CIE 2012 10 Degree Standard Observer'][700])
