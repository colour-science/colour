...
message_box(
    (
        'Converting from "Wright & Guild 1931 2 Degree RGB CMFs" colour '
...
message_box(
    (
        'Converting from "Stiles & Burch 1959 10 Degree RGB CMFs" colour '
...
message_box(
    (
        'Converting from "Stockman & Sharpe 2 Degree Cone Fundamentals" '
...
message_box(
    (
        'Converting from "Stockman & Sharpe 10 Degree Cone Fundamentals" '
        "colour matching functions functions to "
