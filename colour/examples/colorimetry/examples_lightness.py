...
message_box(
    'Computing "Lightness" "CIE L*a*b*" reference value for given '
...
message_box(
    'Computing "Lightness" using "Wyszecki (1963)" method for '
    'given "luminance" value:\n'
    "\n\t{}".format(Y)
)
...
message_box(
    'Computing "Lightness" using "Fairchild and Wyble (2010)" method '
...
message_box(
    'Computing "Lightness" using "Fairchild and Chen (2011)" method '
    'for given "luminance" value:\n'
    "\n\t{}".format(Y)
)
...
message_box(
    'Computing "Lightness" using "CIE 1976" method for '
    'given "luminance" value:\n'
    "\n\t{}".format(Y)
)
