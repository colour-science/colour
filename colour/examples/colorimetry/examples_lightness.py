...
message_box(
    f'Computing "Lightness" "CIE L*a*b*" reference value for given "CIE xyY" colourspace values:\n\n\t{xyY}'
)
...
Y = 12.19722535
message_box(
    f'Computing "Lightness" using "Glasser, Mckinney, Reilly and Schnelle (1958)" method for given "luminance" value:\n\n\t{Y}'
)
...
message_box(
    f'Computing "Lightness" using "Wyszecki (1963)" method for given "luminance" value:\n\n\t{Y}'
)
...
message_box(
    f'Computing "Lightness" using "Fairchild and Wyble (2010)" method for given "luminance" value:\n\n\t{Y}'
)
...
message_box(
    f'Computing "Lightness" using "Fairchild and Chen (2011)" method for given "luminance" value:\n\n\t{Y}'
)
...
message_box(
    f'Computing "Lightness" using "CIE 1976" method for given "luminance" value:\n\n\t{Y}'
)
