...
V = 4.08244375
message_box(
    f'Computing "luminance" using "Newhall, Nickerson, and Judd (1943)" method for given "Munsell" value:\n\n\t{V}'
)
...
message_box(
    f'Computing "luminance" using "Fairchild and Wyble (2010)" method for given "Lightness":\n\n\t{L}'
)
...
message_box(
    f'Computing "luminance" using "Fairchild and Chen (2011)" method for given "Lightness":\n\n\t{L}'
)
...
message_box(
    f'Computing "luminance" using "ASTM D1535-08e1" method for given "Munsell" value:\n\n\t{V}'
)
