...
message_box(
    'Computing "Luminous Flux" for given spectral '
    "distribution:\n"
    "\n\t{}".format(sd_light_source.name)
)
...
message_box(
    'Computing "Luminous Efficiency" for given spectral '
    "distribution:\n"
    "\n\t{}".format(sd_light_source.name)
)
...
message_box(
    'Computing "Luminous Efficacy" for given spectral '
    "distribution:\n"
    "\n\t{}".format(sd_light_source.name)
)
