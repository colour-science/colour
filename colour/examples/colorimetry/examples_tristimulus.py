...
"""
Showcases some **Colour** package colour *tristimulus* values colorimetry related examples.
"""
...
print(colour.wavelength_to_XYZ(546.1, colour.CMFS["CIE 1931 2 Degree Standard Observer"]))
