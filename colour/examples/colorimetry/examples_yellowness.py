...
message_box(
    f'Computing "yellowness" using "ASTM D1925" method for given sample "CIE XYZ" tristimulus values:\n\n\t{XYZ}'
)
...
message_box(
    f'Computing "yellowness" using "ASTM E313" method for given sample "CIE XYZ" tristimulus values:\n\n\t{XYZ}'
)
print(colour.yellowness(XYZ=XYZ, method="ASTM E313"))
print(colour.colorimetry.yellowness_ASTME313(XYZ))

message_box(
    f'Computing "yellowness" using the alternative "ASTM E313" method for given sample "CIE XYZ" tristimulus values:\n\n\t{XYZ}'
)
