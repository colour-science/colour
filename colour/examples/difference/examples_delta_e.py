...
message_box(
    f'Computing "Delta E" with "CIE 1976" method from given "CIE L*a*b*" colourspace matrices:\n\n\t{Lab_1}\n\t{Lab_2}'
)
...
message_box(
    f'Computing "Delta E" with "CIE 1994" method from given "CIE L*a*b*" colourspace matrices:\n\n\t{Lab_1}\n\t{Lab_2}'
)
...
message_box(
    f'Computing "Delta E" with "CIE 1994" method from given "CIE L*a*b*" colourspace matrices for "graphics arts" applications:\n\n\t{Lab_1}\n\t{Lab_2}'
)
...
message_box(
    f'Computing "Delta E" with "CIE 2000" method from given "CIE L*a*b*" colourspace matrices:\n\n\t{Lab_1}\n\t{Lab_2}'
)
...
message_box(
    f'Computing "Delta E" with "CMC" method from given "CIE L*a*b*" colourspace matrices:\n\n\t{Lab_1}\n\t{Lab_2}'
)
...
message_box(
    f'Computing "Delta E" with "CMC" method from given "CIE L*a*b*" colourspace matrices with imperceptibility threshold:\n\n\t{Lab_1}\n\t{Lab_2}'
)
...
message_box(
    f'Computing "Delta E" with "DIN99" method from given "CIE L*a*b*" colourspace matrices:\n\n\t{Lab_1}\n\t{Lab_2}'
)
...
message_box(
    f'Computing "Delta E" with "Luo et al. (2006)" "CAM02-LCD" method from given "J\'a\'b\'" arrays:\n\n\t{Jpapbp_1}\n\t{Jpapbp_2}'
)
...
message_box(
    f'Computing "Delta E" with "Luo et al. (2006)" "CAM02-SCD" method from given "J\'a\'b\'" arrays:\n\n\t{Jpapbp_1}\n\t{Jpapbp_2}'
)
...
message_box(
    f'Computing "Delta E" with "Li et al. (2016)" "CAM02-LCD" method from given "J\'a\'b\'" arrays:\n\n\t{Jpapbp_1}\n\t{Jpapbp_2}'
)
...
message_box(
    f'Computing "Delta E" with "Li et al. (2016)" "CAM16-SCD" method from given "J\'a\'b\'" arrays:\n\n\t{Jpapbp_1}\n\t{Jpapbp_2}'
)
