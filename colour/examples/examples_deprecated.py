...
print(colour.models.deprecated.HSL_to_RGB([0.27867384, 0.94897959, 0.61568627]))
...
print(colour.models.deprecated.CMY_to_RGB([0.50980392, 0.01960784, 0.74901961]))

# Converting from *CMY* colourspace to *CMYK* colourspace.
print(colour.models.deprecated.CMY_to_CMYK([0.50980392, 0.01960784, 0.74901961]))
