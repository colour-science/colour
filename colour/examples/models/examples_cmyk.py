...
message_box(
    f'Converting to "CMY" colourspace from given "RGB" colourspace values:\n\n\t{RGB}'
)
...
message_box(
    f'Converting to "RGB" colourspace from given "CMY" colourspace values:\n\n\t{CMY}'
)
...
message_box(
    f'Converting to "CMYK" colourspace from given "CMY" colourspace values:\n\n\t{CMY}'
)
...
message_box(
    f'Converting to "CMY" colourspace from given "CMYK" colourspace values:\n\n\t{CMYK}'
)
