...
message_box(
    f'Converting from "ITU-R BT.2020" colourspace to "ICtCp" colour encoding given "RGB" values:\n\n\t{RGB}'
)
...
message_box(
    f'Converting from "ICtCp" colour encoding to "ITU-R BT.2020" colourspace given "ICtCp" values:\n\n\t{ICtCp}'
)
