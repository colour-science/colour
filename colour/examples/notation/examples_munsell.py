...
message_box(
    (
        'Computing "Munsell" value using "Moon and Spencer (1943)" '
...
message_box(
    (
        'Computing "Munsell" value using "Saunderson and Milner (1944)" '
        'method for given "luminance" value:\n'
        "\n\t{0}".format(Y)
    )
)
...
message_box(
    (
        'Computing "Munsell" value using "Ladd and Pinney (1955)" method '
...
message_box(
    (
        'Computing "Munsell" value using "McCamy (1987)" method for '
...
message_box(
    (
        'Computing "Munsell" value using "ASTM D1535-08e1" method '
        'for given "luminance" value:\n'
        "\n\t{0}".format(Y)
    )
)
...
message_box(
    (
        'Converting to "Munsell" colour from given "CIE xyY" '
        "colourspace values:\n"
        "\n\t{0}".format(xyY)
    )
)
...
for munsell_colour in ("4.2YR 8.1/5.3", "N8.9"):
    message_box(
        (
            'Converting to "CIE xyY" colourspace from given "Munsell" '
            "colour:\n"
