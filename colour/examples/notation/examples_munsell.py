...
Y = 12.23634268
message_box(
    f'Computing "Munsell" value using "Priest, Gibson and MacNicholas (1920)" method for given "luminance" value:\n\n\t{Y}'
)
...
message_box(
    f'Computing "Munsell" value using "Munsell, Sloan and Godlove (1933)" method for given "luminance" value:\n\n\t{Y}'
)
...
message_box(
    f'Computing "Munsell" value using "Moon and Spencer (1943)" method for given "luminance" value:\n\n\t{Y}'
)
...
message_box(
    f'Computing "Munsell" value using "Saunderson and Milner (1944)" method for given "luminance" value:\n\n\t{Y}'
)
...
message_box(
    f'Computing "Munsell" value using "Ladd and Pinney (1955)" method for given "luminance" value:\n\n\t{Y}'
)
...
message_box(
    f'Computing "Munsell" value using "McCamy (1987)" method for given "luminance" value:\n\n\t{Y}'
)
...
message_box(
    f'Computing "Munsell" value using "ASTM D1535-08e1" method for given "luminance" value:\n\n\t{Y}'
)
...
message_box(
    f'Converting to "Munsell" colour from given "CIE xyY" colourspace values:\n\n\t{xyY}'
)
...
for munsell_colour in ("4.2YR 8.1/5.3", "N8.9"):
    message_box(
        f'Converting to "CIE xyY" colourspace from given "Munsell" colour:\n\n\t{munsell_colour}'
    )
