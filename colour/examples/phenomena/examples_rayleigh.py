...
message_box(
    f'Creating a "Rayleigh" spectral distribution with default spectral shape:\n\n\t{colour.SPECTRAL_SHAPE_DEFAULT}'
)
...
message_box(
    f"Computing the scattering cross section per molecule at given wavelength in cm:\n\n\tWavelength: {wavelength} cm"
)
...
message_box(
    f'Computing the "Rayleigh" optical depth as function of wavelength in cm:\n\n\tWavelength: {wavelength} cm'
)
