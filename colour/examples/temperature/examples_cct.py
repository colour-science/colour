...
message_box(
    f'Converting to "CCT" from given "CIE xy" chromaticity coordinates using "Hernandez-Andres, Lee and Romero (1999)" method:\n\n\t{xy}'
)
...
CCT = 6503.49254150
message_box(
    f'Converting to "CIE xy" chromaticity coordinates from given "CCT" using "Kang, Moon, Hong, Lee, Cho and Kim (2002)" method:\n\n\t{CCT}'
)
