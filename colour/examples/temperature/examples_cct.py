...
message_box(
    'Converting to "CCT" and "D_uv" from given "CIE UCS" colourspace '
...
message_box(
    'Converting to "CCT" from given "CIE xy" chromaticity '
...
CCT = 6503.49254150
message_box(
    'Converting to "CIE xy" chromaticity coordinates from given '
