...
**Description:**
    Defines **Colour** package default constants through the :class:`Constants` class.
...
class Constants():
    """
    Defines **Colour** package default constants.
    """

    application_name = "Colour"
    """
