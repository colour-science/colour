...
class TestLUT_to_LUT(unittest.TestCase):
    ...
    def test_LUT_to_LUT(self):
        ...
        np.testing.assert_almost_equal(
            LUT.table,
            np.array([
                [0.00000000, 0.00000000, 0.27376904],
                [0.05840406, 0.29202031, 0.31905782],
                [0.50804342, 0.40017033, 0.35285470],
                [0.68806746, 0.48115651, 0.38665157],
                [0.82390601, 0.54837380, 0.41535523],
                [0.93702451, 0.60691337, 0.44066342],
                [1.00000000, 0.65935329, 0.46597160],
                [1.00000000, 0.70721023, 0.48955867],
                [1.00000000, 0.75146458, 0.51056407],
                [1.00000000, 0.79279273, 0.53156948],
                [1.00000000, 0.83168433, 0.55203252],
                [1.00000000, 0.86850710, 0.57032614],
                [1.00000000, 0.90354543, 0.58861975],
                [1.00000000, 0.93702451, 0.60691337],
                [1.00000000, 0.96912624, 0.62330084],
                [1.00000000, 1.00000000, 0.63968832],
            ]))
