...
LUTS_DIRECTORY: str = os.path.join(os.path.dirname(__file__), "resources", "sony_spi1d")
...
class TestReadLUTSonySPI1D(unittest.TestCase):
    ...
    def test_read_LUT_SonySPI1D(self):
        ...
        LUT_1 = read_LUT_SonySPI1D(os.path.join(LUTS_DIRECTORY, "eotf_sRGB_1D.spi1d"))
        ...
        LUT_2 = read_LUT_SonySPI1D(os.path.join(LUTS_DIRECTORY, "eotf_sRGB_3x1D.spi1d"))
        self.assertListEqual(
            LUT_2.comments,
            ['Generated by "Colour 0.3.11".', '"colour.models.eotf_sRGB".'],
        )
...
class TestWriteLUTSonySPI1D(unittest.TestCase):
    ...
    def test_write_LUT_SonySPI1D(self):
        ...
        LUT_1_r = read_LUT_SonySPI1D(os.path.join(LUTS_DIRECTORY, "eotf_sRGB_1D.spi1d"))
        write_LUT_SonySPI1D(
            LUT_1_r,
