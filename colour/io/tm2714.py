...
class Header_IESTM2714:
    ...
    def laboratory(self, value: Optional[str]):
        ...
        if value is not None:
            attest(
                is_string(value),
                '"{0}" attribute: "{1}" type is not "str"!'.format("laboratory", value),
            )
    ...
    def comments(self, value: Optional[str]):
        ...
        if value is not None:
            attest(
                is_string(value),
                '"{0}" attribute: "{1}" type is not "str"!'.format("comments", value),
            )
    ...
    *Transmission Geometry*
    ...
    def path(self, value: Optional[str]):
        ...
        if value is not None:
            attest(
                is_string(value),
                '"{0}" attribute: "{1}" type is not "str"!'.format("path", value),
            )
