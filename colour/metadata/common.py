...
def set_callable_metadata(callable_, metadata, *args, **kwargs):
    """
    ...
    \*args : list, optional
        Arguments for the metadata object.
    \**kwargs : dict, optional
        Keywords arguments for the metadata object.
    ...
    >>> def f1():
    ...     pass
    >>> set_callable_metadata(f1, FunctionMetadata,
    ... EntityMetadata('Luminance', '$Y$'),
    ... EntityMetadata('Lightness', '$L^\star$'),
    ... (0, 100),
    ... (0, 100),
...
(0, 100), (0, 100), 'CIE 1976', '$CIE 1976$')
    ...
    callable_.__metadata__ = metadata(*args, **kwargs, callable_=callable_)
