...
# CIE Lab
set_callable_metadata(
    XYZ_to_Lab, ColourModelFunctionMetadata,
    ENTITIES['CIE XYZ'], ENTITIES['CIE Lab'],
    (0, 1), (0, 100))

set_callable_metadata(
    Lab_to_XYZ, ColourModelFunctionMetadata,
    ENTITIES['CIE Lab'], ENTITIES['CIE XYZ'],
    (0, 100), (0, 1))

# CIE LCHab
set_callable_metadata(
    Lab_to_LCHab, ColourModelFunctionMetadata,
    ENTITIES['CIE Lab'], ENTITIES['CIE LCHab'],
    (0, 100), (0, 100))

set_callable_metadata(
    LCHab_to_Lab, ColourModelFunctionMetadata,
    ENTITIES['CIE LCHab'], ENTITIES['CIE Lab'],
    (0, 100), (0, 100))
...
# OETFS / EOTFS
for name, function in OETFS.items():
    set_callable_metadata(
        function, OETFMetadata,
        ENTITIES['Tristimulus Value'], ENTITIES['Video Signal'],
        (0, 1), (0, 1),
        name)

for name, function in EOTFS.items():
    set_callable_metadata(
        function, EOTFMetadata,
        ENTITIES['Video Signal'], ENTITIES['Tristimulus Value'],
        (0, 1), (0, 1),
        name)

if __name__ == '__main__':
    for v in XYZ_to_Lab.__metadata__.instances.values():
        print()
        print(v)
