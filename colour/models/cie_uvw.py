...
def XYZ_to_UVW(XYZ,
    ...
    x, y, Y = np.ravel(colour.models.cie_xyy.XYZ_to_xyY(XYZ, illuminant))
    u, v = np.ravel(colour.models.cie_ucs.UCS_to_uv(
        colour.models.cie_ucs.XYZ_to_UCS(XYZ)))
    u0, v0 = np.ravel(colour.models.cie_ucs.UCS_to_uv(
        colour.models.cie_ucs.XYZ_to_UCS(
            colour.models.cie_xyy.xy_to_XYZ(illuminant))))
