...
ALEXA_WIDE_GAMUT_RGB_PRIMARIES = np.array([0.6840, 0.3130,
                                           0.2210, 0.8480,
                                           0.0861, -0.1020]).reshape((3, 2))

ALEXA_WIDE_GAMUT_RGB_WHITEPOINT = ILLUMINANTS.get("CIE 1931 2 Degree Standard Observer").get("D65")

ALEXA_WIDE_GAMUT_RGB_TO_XYZ_MATRIX = np.array([0.638008, 0.214704, 0.097744,
                                               0.291954, 0.823841, -0.115795,
                                               0.002798, -0.067034, 1.153294]).reshape((3, 3))

XYZ_TO_ALEXA_WIDE_GAMUT_RGB_MATRIX = np.linalg.inv(ALEXA_WIDE_GAMUT_RGB_TO_XYZ_MATRIX)
