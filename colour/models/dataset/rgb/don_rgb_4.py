...
DON_RGB_4_WHITEPOINT = ILLUMINANTS.get("CIE 1931 2 Degree Standard Observer").get("D50")

DON_RGB_4_TO_XYZ_MATRIX = get_normalised_primary_matrix(DON_RGB_4_PRIMARIES, DON_RGB_4_WHITEPOINT)
