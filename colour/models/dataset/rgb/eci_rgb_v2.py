...
ECI_RGB_V2_WHITEPOINT = ILLUMINANTS.get("CIE 1931 2 Degree Standard Observer").get("D50")

ECI_RGB_V2_TO_XYZ_MATRIX = get_normalised_primary_matrix(ECI_RGB_V2_PRIMARIES, ECI_RGB_V2_WHITEPOINT)
