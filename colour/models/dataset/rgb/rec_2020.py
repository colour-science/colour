...
REC_2020_WHITEPOINT = ILLUMINANTS.get("CIE 1931 2 Degree Standard Observer").get("D65")

REC_2020_TO_XYZ_MATRIX = get_normalised_primary_matrix(REC_2020_PRIMARIES, REC_2020_WHITEPOINT)
