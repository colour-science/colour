...
RUSSELL_RGB_WHITEPOINT = ILLUMINANTS.get("CIE 1931 2 Degree Standard Observer").get("D55")

RUSSELL_RGB_TO_XYZ_MATRIX = get_normalised_primary_matrix(RUSSELL_RGB_PRIMARIES, RUSSELL_RGB_WHITEPOINT)
