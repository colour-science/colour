...
XTREME_RGB_PRIMARIES = np.array([1., 0.,
                                    0., 1.,
                                    0., 0.]).reshape((3, 2))

XTREME_RGB_WHITEPOINT = colour.colorimetry.dataset.illuminants.chromaticity_coordinates.ILLUMINANTS.get(
    "CIE 1931 2 Degree Standard Observer").get("D50")

XTREME_RGB_TO_XYZ_MATRIX = colour.models.rgb.derivation.get_normalised_primary_matrix(
