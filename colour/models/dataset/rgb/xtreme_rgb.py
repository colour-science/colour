...
XTREME_RGB_WHITEPOINT = ILLUMINANTS.get("CIE 1931 2 Degree Standard Observer").get("D50")

XTREME_RGB_TO_XYZ_MATRIX = get_normalised_primary_matrix(XTREME_RGB_PRIMARIES, XTREME_RGB_WHITEPOINT)
