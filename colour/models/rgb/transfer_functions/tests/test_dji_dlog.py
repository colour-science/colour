...
from colour.models.rgb.transfer_functions import (log_encoding_DJIDLog,
...
__all__ = ['TestLogEncoding_DJIDLog', 'TestLogDecoding_DJIDLog']
...
log_encoding_DJIDLog` definition.
        ...
        self.assertAlmostEqual(log_encoding_DJIDLog(0.0),
                               0.0929,
                               places=7)
        ...
        self.assertAlmostEqual(
            log_encoding_DJIDLog(1.0), 0.584555, places=7)
...
log_encoding_DJIDLog` definition n-dimensional arrays support.
        ...
        np.testing.assert_almost_equal(
            log_encoding_DJIDLog(x), y, decimal=7)
...
log_encoding_DJIDLog` definition nan support.
        ...
        log_encoding_DJIDLog(np.array([-1.0,
                                       0.0,
                                       1.0,
                                       -np.inf,
                                       np.inf,
...
log_decoding_FilmLight_T_Log` definition.
        ...
        self.assertAlmostEqual(log_decoding_DJIDLog(0.0929),
                               0.0,
                               places=7)
        ...
        self.assertAlmostEqual(
            log_decoding_DJIDLog(0.584555), 1.0, places=6)
...
log_decoding_DJIDLog` definition n-dimensional arrays support.
        ...
        x = 0.18
        np.testing.assert_almost_equal(
            log_decoding_DJIDLog(y), x, decimal=7)
...
log_decoding_FilmLight_T_Log` definition nan support.
        ...
        log_decoding_DJIDLog(np.array([-1.0,
                                       0.0,
                                       1.0,
                                       -np.inf,
                                       np.inf,
