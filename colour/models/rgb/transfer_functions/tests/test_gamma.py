...
function_gamma` definition.
        ...
        self.assertAlmostEqual(
            function_gamma(0.0, -2.2, 'Mirror'), 0.0, places=7)

        self.assertAlmostEqual(
            function_gamma(0.0, 2.2, 'Preserve'), 0.0, places=7)

        self.assertAlmostEqual(function_gamma(0.0, 2.2, 'Clamp'), 0, places=7)
...
function_gamma` definition n-dimensional arrays support.
        ...
        np.testing.assert_almost_equal(
            function_gamma(a, 2.2, 'Mirror'), a_p, decimal=7)
        ...
        a_p = -0.18
        np.testing.assert_almost_equal(
            function_gamma(a, 2.2, 'Preserve'), a_p, decimal=7)
        ...
        a_p = 0.0
        np.testing.assert_almost_equal(
            function_gamma(a, 2.2, 'Clamp'), a_p, decimal=7)
