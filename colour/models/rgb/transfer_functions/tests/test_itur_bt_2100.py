...
oetf_PQ_BT2100` definition n-dimensional arrays support.
        ...
        E = np.tile(E, 6)
        E_p = np.tile(E_p, 6)
        np.testing.assert_array_almost_equal(oetf_PQ_BT2100(E), E_p, decimal=7)
...
eotf_PQ_BT2100` definition n-dimensional arrays support.
        ...
        F_D = np.tile(F_D, 6)
        np.testing.assert_array_almost_equal(
            eotf_PQ_BT2100(E_p), F_D, decimal=7)
...
ootf_PQ_BT2100` definition n-dimensional arrays support.
        ...
        E = np.tile(E, 6)
        F_D = np.tile(F_D, 6)
        np.testing.assert_array_almost_equal(ootf_PQ_BT2100(E), F_D, decimal=7)
...
oetf_HLG_BT2100` definition n-dimensional arrays support.
        ...
        E_p = np.tile(E_p, 6)
        np.testing.assert_array_almost_equal(
            oetf_HLG_BT2100(E), E_p, decimal=7)
...
eotf_HLG_BT2100_1` definition n-dimensional arrays support.
        ...
        F_D = np.tile(F_D, 6)
        np.testing.assert_array_almost_equal(
            eotf_HLG_BT2100_1(E_p), F_D, decimal=7)
...
eotf_HLG_BT2100_2` definition n-dimensional arrays support.
        ...
        F_D = np.tile(F_D, 6)
        np.testing.assert_array_almost_equal(
            eotf_HLG_BT2100_2(E_p), F_D, decimal=7)
...
ootf_HLG_BT2100_1` definition n-dimensional arrays support.
        ...
        F_D = np.tile(F_D, 6)
        np.testing.assert_array_almost_equal(
            ootf_HLG_BT2100_1(E), F_D, decimal=7)
...
ootf_HLG_BT2100_2` definition n-dimensional arrays support.
        ...
        F_D = np.tile(F_D, 6)
        np.testing.assert_array_almost_equal(
            ootf_HLG_BT2100_2(E), F_D, decimal=7)
