...
__all__ = ['TestEotf_reverse_ST2084', 'TestEotf_ST2084']


class TestEotf_reverse_ST2084(unittest.TestCase):
    """
    Defines :func:`colour.models.rgb.transfer_functions.st_2084.\
eotf_reverse_ST2084` definition unit tests methods.
    """

    def test_eotf_reverse_ST2084(self):
        """
        Tests :func:`colour.models.rgb.transfer_functions.st_2084.\
eotf_reverse_ST2084` definition.
        """

        self.assertAlmostEqual(
            eotf_reverse_ST2084(0.0), 0.000000730955903, places=7)

        self.assertAlmostEqual(
            eotf_reverse_ST2084(100), 0.508078421517399, places=7)

        self.assertAlmostEqual(
            eotf_reverse_ST2084(400), 0.652578597563067, places=7)

        self.assertAlmostEqual(eotf_reverse_ST2084(5000, 5000), 1.0, places=7)

    def test_n_dimensional_eotf_reverse_ST2084(self):
        """
        Tests :func:`colour.models.rgb.transfer_functions.st_2084.\
eotf_reverse_ST2084` definition n-dimensional arrays support.
        """

        C = 100
        N = eotf_reverse_ST2084(C)

        C = np.tile(C, 6)
        N = np.tile(N, 6)
        np.testing.assert_almost_equal(eotf_reverse_ST2084(C), N, decimal=7)
    ...
    def test_domain_range_scale_eotf_reverse_ST2084(self):
        """
        Tests :func:`colour.models.rgb.transfer_functions.st_2084.\
eotf_reverse_ST2084` definition domain and range scale support.
        """
        ...
        for scale, factor in d_r:
            with domain_range_scale(scale):
                np.testing.assert_almost_equal(
                    eotf_reverse_ST2084(C * factor), N * factor, decimal=7)

    @ignore_numpy_errors
    def test_nan_eotf_reverse_ST2084(self):
        """
        Tests :func:`colour.models.rgb.transfer_functions.st_2084.\
eotf_reverse_ST2084` definition nan support.
        """
