...
class TestUCS_uv_to_xy(unittest.TestCase):
    ...
    def test_UCS_uv_to_xy(self):
        ...
        np.testing.assert_almost_equal(
            colour.models.cie_ucs.UCS_uv_to_xy((0.2033733344733139, 0.3140500001549052)),
            (0.32207410281368043, 0.33156550013623537),
            decimal=7)

        np.testing.assert_almost_equal(
            colour.models.cie_ucs.UCS_uv_to_xy((0.20873418102926322, 0.32457285063327812)),
            (0.3439000000209443, 0.35650000010917804),
            decimal=7)

        np.testing.assert_almost_equal(
            colour.models.cie_ucs.UCS_uv_to_xy((0.25585459629500179, 0.34952813701502972)),
