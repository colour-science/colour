...
class TestIsWithinMacadamLimits(unittest.TestCase):
    ...
    def test_is_within_macadam_limits(self):
        ...
        self.assertTrue(colour.models.cie_xyy.is_within_macadam_limits((0.3205, 0.4131, 0.51), "A"))
        self.assertFalse(colour.models.cie_xyy.is_within_macadam_limits((0.0005, 0.0031, 0.001), "A"))
        self.assertTrue(colour.models.cie_xyy.is_within_macadam_limits((0.4325, 0.3788, 0.1034), "C"))
        self.assertFalse(colour.models.cie_xyy.is_within_macadam_limits((0.0025, 0.0088, 0.034), "C"))
