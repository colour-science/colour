...
class Testxy_to_z(unittest.TestCase):
    """
    Defines :func:`colour.models.rgb.derivation.xy_to_z` definition units tests methods.
    """
    ...
    def test_xy_to_z(self):
        ...
        np.testing.assert_almost_equal(
            colour.models.rgb.derivation.xy_to_z((0.25, 0.25)), 0.5, decimal=7)

        np.testing.assert_almost_equal(
            colour.models.rgb.derivation.xy_to_z((0.00010, -0.07700)), 1.07690, decimal=7)

        np.testing.assert_almost_equal(
            colour.models.rgb.derivation.xy_to_z((0.00000, 1.00000)), 0.00000, decimal=7)


class TestGetNormalisedPrimaryMatrix(unittest.TestCase):
    """
    Defines :func:`colour.models.rgb.derivation.get_normalised_primary_matrix` definition units tests methods.
    """

    def test_get_normalised_primary_matrix(self):
        """
        Tests :func:`colour.models.rgb.derivation.get_normalised_primary_matrix` definition.
        """

        np.testing.assert_almost_equal(
            colour.models.rgb.derivation.get_normalised_primary_matrix(
...
class TestGetRGBLuminanceEquation(unittest.TestCase):
    """
    Defines :func:`colour.models.rgb.derivation.get_RGB_luminance_equation` definition units tests methods.
    """

    def test_get_RGB_luminance_equation(self):
        """
        Tests :func:`colour.models.rgb.derivation.get_RGB_luminance_equation` definition.
        """

        self.assertIsInstance(colour.models.rgb.derivation.get_RGB_luminance_equation(
            np.array([0.73470, 0.26530,
                         0.00000, 1.00000,
                         0.00010, -0.07700]),
        ...
        self.assertTrue(re.match(
            ...
            colour.models.rgb.derivation.get_RGB_luminance_equation(
                np.array([0.73470, 0.26530,
                             0.00000, 1.00000,
                             0.00010, -0.07700]),
                (0.32168, 0.33767))))
...
class TestGetRGBLuminance(unittest.TestCase):
    """
    Defines :func:`colour.models.rgb.derivation.get_RGB_luminance` definition units tests methods.
    """
    ...
    def test_get_RGB_luminance(self):
        ...
        self.assertAlmostEqual(
            colour.models.rgb.derivation.get_RGB_luminance(
                np.array([50., 50., 50.]),
                np.array([0.73470, 0.26530,
                             0.00000, 1.00000,
                             0.00010, -0.07700]),
