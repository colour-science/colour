...
from colour.models import get_normalised_primary_matrix, get_RGB_luminance_equation, get_RGB_luminance
...
class Testxy_to_z(unittest.TestCase):
    ...
    def test_xy_to_z(self):
        ...
        np.testing.assert_almost_equal(xy_to_z((0.25, 0.25)), 0.5, decimal=7)

        np.testing.assert_almost_equal(xy_to_z((0.00010, -0.07700)), 1.07690, decimal=7)

        np.testing.assert_almost_equal(xy_to_z((0.00000, 1.00000)), 0.00000, decimal=7)
