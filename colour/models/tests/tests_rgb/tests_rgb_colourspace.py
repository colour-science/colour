...
from colour.models import RGB_COLOURSPACES, xyY_to_RGB, RGB_to_xyY, XYZ_to_RGB, RGB_to_XYZ, RGB_to_RGB
    ...
    def test_XYZ_to_RGB(self):
        ...
        for xyY, XYZ, RGB in sRGB_LINEAR_COLORCHECKER_2005:
            np.testing.assert_almost_equal(
                XYZ_to_RGB(np.array(XYZ).reshape((3, 1)),
                           (0.34567, 0.35850),
                           (0.31271, 0.32902),
                           "Bradford",
                           np.array(
...
class TestxyY_to_RGB(unittest.TestCase):
    ...
    def test_xyY_to_RGB(self):
        ...
        for xyY, XYZ, RGB in sRGB_LINEAR_COLORCHECKER_2005:
            np.testing.assert_almost_equal(
                xyY_to_RGB(np.array(xyY).reshape((3, 1)),
                           (0.34567, 0.35850),
                           (0.31271, 0.32902),
                           "Bradford",
                           np.array(
