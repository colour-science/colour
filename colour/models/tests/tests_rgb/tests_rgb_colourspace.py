...
**Description:**
    Defines units tests for :mod:`colour.models.rgb.rgb_colourspace` module.
...
import colour.models.dataset.rgb.aces_rgb
...
class TestXYZ_to_RGB(unittest.TestCase):
    """
    Defines :func:`colour.models.rgb.rgb_colourspace.XYZ_to_RGB` definition units tests methods.
    """
...
class TestRGB_to_XYZ(unittest.TestCase):
    """
    Defines :func:`colour.models.rgb.rgb_colourspace.RGB_to_XYZ` definition units tests methods.
    """
...
class TestxyY_to_RGB(unittest.TestCase):
    """
    Defines :func:`colour.models.rgb.rgb_colourspace.xyY_to_RGB` definition units tests methods.
    """

    def test_xyY_to_RGB(self):
        """
        Tests :func:`colour.models.rgb.rgb_colourspace.xyY_to_RGB` definition.
        """

        for xyY, XYZ, RGB in sRGB_LINEAR_COLORCHECKER_2005:
            np.testing.assert_almost_equal(
                colour.models.rgb.rgb_colourspace.xyY_to_RGB(
...
class TestRGB_to_xyY(unittest.TestCase):
    """
    Defines :func:`colour.models.rgb.rgb_colourspace.RGB_to_xyY` definition units tests methods.
    """

    def test_RGB_to_xyY(self):
        """
        Tests :func:`colour.models.rgb.rgb_colourspace.RGB_to_xyY` definition.
        """

        for xyY, XYZ, RGB in sRGB_LINEAR_COLORCHECKER_2005:
            np.testing.assert_almost_equal(
                colour.models.rgb.rgb_colourspace.RGB_to_xyY(
                    RGB,
                    (0.31271, 0.32902),
                    (0.34567, 0.35850),
                    "Bradford",
...
class TestRGB_to_RGB(unittest.TestCase):
    """
    Defines :func:`colour.models.rgb.rgb_colourspace.RGB_to_RGB` definition units tests methods.
    """
    ...
    def test_RGB_to_RGB(self):
        ...
        aces_rgb_colourspace = colour.models.dataset.rgb.aces_rgb.ACES_RGB_COLOURSPACE
        sRGB_colourspace = colour.models.dataset.rgb.srgb.sRGB_COLOURSPACE
        ...
        np.testing.assert_almost_equal(
            colour.models.rgb.rgb_colourspace.RGB_to_RGB(
                ...
                sRGB_colourspace),
            np.array([0.33658567, 0.44096335, 0.21509975]).reshape((3, 1)),
            decimal=7)
        ...
        np.testing.assert_almost_equal(
            colour.models.rgb.rgb_colourspace.RGB_to_RGB(
                ...
                sRGB_colourspace,
                aces_rgb_colourspace),
            np.array([0.35521588, 0.41, 0.24177934]).reshape((3, 1)),
            decimal=7)
