...
"""
CAM02-LCD, CAM02-SCD, and CAM02-UCS Colourspaces - Luo (2016)
=============================================================

Defines the Luo (2016) *CAM02-LCD*, *CAM02-SCD*, and *CAM02-UCS* colourspaces
transformations:
...
class Coefficients_UCS_Luo2006(
    namedtuple('Coefficients_UCS_Luo2006',
               ('K_L', 'c_1', 'c_2'))):
    """
    Defines the the class storing Luo (2016) fitting coefficients for the
...
"""
Luo (2016) fitting coefficients for the *CAM02-LCD*, *CAM02-SCD*, and
...
def JMh_CIECAM02_to_UCS_Luo2006(JMh, coefficients):
    ...
    Luo (2016) *CAM02-LCD*, *CAM02-SCD*, or *CAM02-UCS* colourspaces
    :math:`J'a'b'` array.
    ...
    *colourfulness* :math:`M` and the CIECAM02 *Hue* angle :math:`h` in
    ...
    coefficients : array_like
        Coefficients of one of the Luo (2016) *CAM02-LCD*, *CAM02-SCD*, or
        *CAM02-UCS* colourspaces.
...
def UCS_Luo2006_to_JMh_CIECAM02(Jpapbp, coefficients):
    """
    Converts from one of the Luo (2016) *CAM02-LCD*, *CAM02-SCD*, or
