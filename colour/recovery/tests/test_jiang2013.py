...
class TestPCA_Jiang2013:
    ...
    def test_PCA_Jiang2013(self) -> None:
        ...
        # NOTE: Only the first two components are compared: the third
        # eigenvalue is zero (see the eigenvalues asserted below), thus the
        # third eigenvector spans the covariance matrix null space and its
        # direction is arbitrary, varying across *LAPACK* / *BLAS* backends.
        xp_assert_close(
            np.abs(np.array(w))[..., :2],
            np.array(
                [
                    [
                        [0.00137594, 0.00399416, 0.00069230],
                        [0.00214835, 0.00184422, 0.77773975],
                        [0.02757181, 0.00553587, 0.01405320],
                        [0.02510621, 0.04216468, 0.01296328],
                        [0.02011623, 0.03371162, 0.00006511],
                        [0.01392282, 0.03297985, 0.00076254],
                        [0.00944513, 0.03300938, 0.00272538],
                        [0.02019958, 0.01289400, 0.00733623],
                        [0.02394423, 0.00980934, 0.00116771],
                        [0.04196326, 0.04987050, 0.01214103],
                        [0.04988732, 0.06936603, 0.06276533],
                        [0.06527141, 0.09378614, 0.00531553],
                        [0.09412575, 0.12244081, 0.04024341],
                        [0.10915913, 0.13119983, 0.01812631],
                        [0.12314840, 0.24280936, 0.06691737],
                        [0.11673941, 0.27700737, 0.13336210],
                        [0.12534133, 0.29994127, 0.09242404],
                        [0.14599255, 0.25586532, 0.02807276],
                        [0.25249090, 0.11499750, 0.22445012],
                        [0.35163407, 0.45286818, 0.08876308],
                        [0.35805737, 0.40724252, 0.25003734],
                        [0.36927899, 0.18120838, 0.32590277],
                        [0.35374885, 0.03010008, 0.02424606],
                        [0.35340909, 0.16847527, 0.27657455],
                        [0.32696116, 0.29068981, 0.17751100],
                        [0.29067354, 0.32862702, 0.14423389],
                        [0.08964758, 0.09682656, 0.02477972],
                        [0.01891664, 0.08221113, 0.00586036],
                        [0.00521149, 0.01578907, 0.00094325],
                        [0.00232366, 0.00137751, 0.00072684],
                        [0.00153787, 0.00254398, 0.00141550],
                    ],
                    [
                        [0.00119598, 0.00267792, 0.00023837],
                        [0.00200327, 0.00322983, 0.65812760],
                        [0.01247816, 0.03313976, 0.00904730],
                        [0.03207685, 0.05703294, 0.03496281],
                        [0.04715050, 0.05296451, 0.00746348],
                        [0.05794010, 0.05455737, 0.00797326],
                        [0.10745571, 0.00158911, 0.03618865],
                        [0.14178525, 0.03362764, 0.13230117],
                        [0.16811402, 0.05569833, 0.00126897],
                        [0.18463716, 0.04615404, 0.06782785],
                        [0.21531623, 0.09745078, 0.35536881],
                        [0.25442570, 0.18330481, 0.35550206],
                        [0.28168018, 0.25193267, 0.01940794],
                        [0.29237178, 0.28545428, 0.03329913],
                        [0.29693117, 0.23909467, 0.08279249],
                        [0.28631319, 0.19476441, 0.31831349],
                        [0.27195968, 0.12087420, 0.22952523],
                        [0.25988140, 0.01581316, 0.03590514],
                        [0.24222660, 0.07912972, 0.06974551],
                        [0.23069698, 0.18583667, 0.17749567],
                        [0.20831983, 0.26745561, 0.13252356],
                        [0.19437168, 0.32425009, 0.04031449],
                        [0.18470894, 0.34768079, 0.15702008],
                        [0.18056180, 0.35983221, 0.20231477],
                        [0.17141337, 0.35067306, 0.06430943],
                        [0.14712541, 0.30423172, 0.01311752],
                        [0.02897026, 0.04573993, 0.01639128],
                        [0.00190228, 0.00461591, 0.00181558],
                        [0.00069122, 0.00118817, 0.00067073],
                        [0.00045559, 0.00015286, 0.00094386],
                        [0.00039509, 0.00049719, 0.00108501],
                    ],
                    [
                        [0.03283371, 0.04707162, 0.99686696],
                        [0.05932690, 0.07529740, 0.04777270],
                        [0.11947381, 0.07977219, 0.00288653],
                        [0.18492233, 0.26127374, 0.00866928],
                        [0.22091564, 0.29279976, 0.00603777],
                        [0.25377875, 0.30677709, 0.00676444],
                        [0.29969822, 0.26541777, 0.00148929],
                        [0.30232755, 0.25378622, 0.00171034],
                        [0.30031732, 0.19751184, 0.00110617],
                        [0.28072276, 0.11804285, 0.00208954],
                        [0.26005747, 0.01836333, 0.00966177],
                        [0.23839367, 0.07182421, 0.01710700],
                        [0.21721831, 0.14245410, 0.01392494],
                        [0.19828405, 0.17684950, 0.01418532],
                        [0.19018451, 0.20137781, 0.01321413],
                        [0.18196762, 0.22086321, 0.01368810],
                        [0.17168644, 0.22771873, 0.02026592],
                        [0.16977073, 0.23504018, 0.01653275],
                        [0.16277670, 0.22897797, 0.01885420],
                        [0.15880423, 0.22583675, 0.01867897],
                        [0.14966812, 0.21494312, 0.01549527],
                        [0.13480155, 0.19511162, 0.01726259],
                        [0.12541764, 0.18113238, 0.01356430],
                        [0.12355731, 0.17835150, 0.01510287],
                        [0.11175064, 0.15997651, 0.01354602],
                        [0.09440304, 0.13423453, 0.01141010],
                        [0.01670581, 0.02019670, 0.00146819],
                        [0.00045002, 0.00147362, 0.00006780],
                        [0.00102919, 0.00095904, 0.00010087],
                        [0.00097397, 0.00123434, 0.00010268],
                        [0.00097116, 0.00124835, 0.00011990],
                    ],
                ]
            )[..., :2],
