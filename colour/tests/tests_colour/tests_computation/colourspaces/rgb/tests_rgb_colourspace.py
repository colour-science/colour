...
**Description:**
    Defines units tests for :mod:`colour.computation.colourspaces.rgb.rgb_colourspace` module.
...
import colour.dataset.colourspaces.rgb.aces_rgb
...
ACES_COLORCHECKER_2005 = [
    [[0.4316, 0.3777, 0.1008],
     (0.11518474980142972, 0.1008, 0.050893725178713274),
     numpy.array([[0.11758989],
                  [0.08781098],
                  [0.06184838]])],
    [[0.4197, 0.3744, 0.34950000000000003],
     (0.39178725961538463, 0.34950000000000003, 0.19220633012820515),
     numpy.array([[0.40073605],
                  [0.31020146],
                  [0.2334411]])],
    [[0.276, 0.3016, 0.18359999999999999],
     (0.1680159151193634, 0.18359999999999999, 0.25713740053050399),
     numpy.array([[0.17949613],
                  [0.20101795],
                  [0.31109218]])],
    [[0.3703, 0.4499, 0.1325],
     (0.10905701266948212, 0.13250000000000001, 0.052952878417426061),
     numpy.array([[0.1107181],
                  [0.13503098],
                  [0.06442476]])],
    [[0.2999, 0.2856, 0.2304],
     (0.24193613445378148, 0.23039999999999999, 0.33438655462184863),
     numpy.array([[0.2575148],
                  [0.23804357],
                  [0.40454743]])],
    [[0.2848, 0.3911, 0.4178],
     (0.30424300690360523, 0.4178, 0.34622597801073896),
     numpy.array([[0.31733562],
                  [0.46758348],
                  [0.41947022]])],
    [[0.5295, 0.4055, 0.3118],
     (0.40714697903822439, 0.31180000000000002, 0.049980271270036999),
     numpy.array([[0.41040872],
                  [0.23293505],
                  [0.06167114]])],
    [[0.2305, 0.2106, 0.11259999999999999],
     (0.1232397910731244, 0.11259999999999999, 0.29882307692307686),
     numpy.array([[0.13747056],
                  [0.13033376],
                  [0.36114764]])],
    [[0.5012, 0.3273, 0.1938],
     (0.29676920256645278, 0.1938, 0.10154812098991754),
     numpy.array([[0.30304559],
                  [0.13139056],
                  [0.12344791]])],
    [[0.3319, 0.2482, 0.0637],
     (0.085181426269137786, 0.063700000000000007, 0.1077664383561644),
     numpy.array([[0.09058405],
                  [0.05847923],
                  [0.13035265]])],
    [[0.3984, 0.5008, 0.4446],
     (0.35369137380191684, 0.4446, 0.089488178913738003),
     numpy.array([[0.3547791],
                  [0.44849679],
                  [0.10971221]])],
    [[0.4957, 0.4427, 0.4357],
     (0.48786196069573068, 0.43569999999999998, 0.060625976959566286),
     numpy.array([[0.49038927],
                  [0.36515801],
                  [0.07497681]])],
    [[0.2018, 0.1692, 0.0575],
     (0.068578605200945636, 0.057500000000000002, 0.21375591016548467),
     numpy.array([[0.07890084],
                  [0.07117527],
                  [0.25824906]])],
    [[0.3253, 0.5032, 0.2318],
     (0.14985003974562797, 0.23180000000000001, 0.079001788553259192),
     numpy.array([[0.15129818],
                  [0.25515937],
                  [0.09620886]])],
    [[0.5686, 0.3303, 0.1257],
     (0.21638819255222524, 0.12570000000000001, 0.038474931880109003),
     numpy.array([[0.21960818],
                  [0.06985597],
                  [0.04703204]])],
    [[0.4697, 0.4734, 0.5981000000000001],
     (0.59342536966624426, 0.59810000000000008, 0.071888234051542058),
     numpy.array([[0.5948559],
                  [0.5382559],
                  [0.08916818]])],
    [[0.4159, 0.2688, 0.2009],
     (0.3108419270833333, 0.2009, 0.2356539062500001),
     numpy.array([[0.32368864],
                  [0.15049668],
                  [0.28535138]])],
    [[0.2131, 0.3023, 0.193],
     (0.13605127356930202, 0.193, 0.30938736354614615),
     numpy.array([[0.14920707],
                  [0.23648468],
                  [0.37415686]])],
    [[0.3469, 0.3608, 0.9131],
     (0.87792236696230597, 0.91310000000000002, 0.73974259977827039),
     numpy.array([[0.90989008],
                  [0.91268206],
                  [0.89651699]])],
    [[0.344, 0.3584, 0.5893999999999999],
     (0.56571874999999983, 0.58939999999999992, 0.48941249999999997),
     numpy.array([[0.58690823],
                  [0.59107342],
                  [0.59307473]])],
    [[0.3432, 0.3581, 0.3632],
     (0.34808779670483109, 0.36320000000000002, 0.30295403518570241),
     numpy.array([[0.36120089],
                  [0.36465935],
                  [0.36711553]])],
    [[0.3446, 0.3579, 0.19149999999999998],
     (0.18438362671137187, 0.19149999999999998, 0.15918203408773396),
     numpy.array([[0.19128766],
                  [0.19177359],
                  [0.19289805]])],
    [[0.3401, 0.3548, 0.0883],
     (0.084641572717023675, 0.088300000000000003, 0.075931031567080032),
     numpy.array([[0.08793956],
                  [0.08892476],
                  [0.09200134]])],
    [[0.3406, 0.3537, 0.0311],
     (0.029948148148148147, 0.031099999999999999, 0.026879474130619162),
     numpy.array([[0.03111895],
                  [0.03126787],
                  [0.03256784]])]]
...
class TestXYZ_to_RGB(unittest.TestCase):
    """
    Defines :func:`colour.computation.colourspaces.rgb.rgb_colourspace.XYZ_to_RGB` definition units tests methods.
    """

    def test_XYZ_to_RGB(self):
        """
        Tests :func:`colour.computation.colourspaces.rgb.rgb_colourspace.XYZ_to_RGB` definition.
        """

        for xyY, XYZ, RGB in sRGB_LINEAR_COLORCHECKER_2005:
            numpy.testing.assert_almost_equal(
                colour.computation.colourspaces.rgb.rgb_colourspace.XYZ_to_RGB(
                    numpy.array(XYZ).reshape((3, 1)),
                    (0.34567, 0.35850),
                    (0.31271, 0.32902),
                    "Bradford",
                    numpy.array(
                ...
                colour.computation.colourspaces.rgb.rgb_colourspace.XYZ_to_RGB(
                    ...
                    numpy.array(
                        [1.04981102e+00, 0.00000000e+00, -9.74845410e-05,
                         ...
                         0.00000000e+00, 0.00000000e+00, 9.91252022e-01]).reshape((3, 3))),
                RGB,
                decimal=7)
...
class TestRGB_to_XYZ(unittest.TestCase):
    """
    Defines :func:`colour.computation.colourspaces.rgb.rgb_colourspace.RGB_to_XYZ` definition units tests methods.
    """

    def test_RGB_to_XYZ(self):
        """
        Tests :func:`colour.computation.colourspaces.rgb.rgb_colourspace.RGB_to_XYZ` definition.
        """

        for xyY, XYZ, RGB in sRGB_LINEAR_COLORCHECKER_2005:
            numpy.testing.assert_almost_equal(
                colour.computation.colourspaces.rgb.rgb_colourspace.RGB_to_XYZ(
                    RGB,
                    (0.31271, 0.32902),
                    (0.34567, 0.35850),
                    "Bradford",
...
class TestxyY_to_RGB(unittest.TestCase):
    """
    Defines :func:`colour.computation.colourspaces.rgb.rgb_colourspace.xyY_to_RGB` definition units tests methods.
    """

    def test_xyY_to_RGB(self):
        """
        Tests :func:`colour.computation.colourspaces.rgb.rgb_colourspace.xyY_to_RGB` definition.
        """

        for xyY, XYZ, RGB in sRGB_LINEAR_COLORCHECKER_2005:
            numpy.testing.assert_almost_equal(
                colour.computation.colourspaces.rgb.rgb_colourspace.xyY_to_RGB(
                    numpy.array(xyY).reshape((3, 1)),
                    (0.34567, 0.35850),
                    (0.31271, 0.32902),
                    "Bradford",
                    numpy.array(
...
class TestRGB_to_xyY(unittest.TestCase):
    """
    Defines :func:`colour.computation.colourspaces.rgb.rgb_colourspace.RGB_to_xyY` definition units tests methods.
    """

    def test_RGB_to_xyY(self):
        """
        Tests :func:`colour.computation.colourspaces.rgb.rgb_colourspace.RGB_to_xyY` definition.
        """

        for xyY, XYZ, RGB in sRGB_LINEAR_COLORCHECKER_2005:
            numpy.testing.assert_almost_equal(
                colour.computation.colourspaces.rgb.rgb_colourspace.RGB_to_xyY(
                    RGB,
                    (0.31271, 0.32902),
                    (0.34567, 0.35850),
                    "Bradford",
...
class TestRGB_to_RGB(unittest.TestCase):
    """
    Defines :func:`colour.computation.colourspaces.rgb.rgb_colourspace.RGB_to_RGB` definition units tests methods.
    """

    def test_RGB_to_RGB(self):
        """
        Tests :func:`colour.computation.colourspaces.rgb.rgb_colourspace.RGB_to_RGB` definition.
        """

        aces_rgb_colourspace = colour.dataset.colourspaces.rgb.aces_rgb.ACES_RGB_COLOURSPACE
        sRGB_colourspace = colour.dataset.colourspaces.rgb.srgb.sRGB_COLOURSPACE

        numpy.testing.assert_almost_equal(
            colour.computation.colourspaces.rgb.rgb_colourspace.RGB_to_RGB(
                (0.35521588, 0.41, 0.24177934),
                aces_rgb_colourspace,
                sRGB_colourspace),
            numpy.array([0.33658567, 0.44096335, 0.21509975]).reshape((3, 1)),
            decimal=7)

        numpy.testing.assert_almost_equal(
            colour.computation.colourspaces.rgb.rgb_colourspace.RGB_to_RGB(
                (0.33658567, 0.44096335, 0.21509975),
                sRGB_colourspace,
                aces_rgb_colourspace),
            numpy.array([0.35521588, 0.41, 0.24177934]).reshape((3, 1)),
            decimal=7)
        ...
        numpy.testing.assert_almost_equal(
            colour.computation.colourspaces.rgb.rgb_colourspace.RGB_to_RGB(
                ...
                sRGB_colourspace,
                "Bradford"),
            numpy.array([0.33704409, 0.44133521, 0.21429761]).reshape((3, 1)),
            decimal=7)
