...
class TestXYZ_to_Lab(unittest.TestCase):
    """
    Defines :func:`colour.computation.colourspaces.cie_lab.XYZ_to_Lab` definition units tests methods.
    """
    ...
    def test_XYZ_to_Lab(self):
        ...
        numpy.testing.assert_almost_equal(colour.computation.colourspaces.cie_lab.XYZ_to_Lab(numpy.matrix([0.96907232,
                                                                                                           1.,
                                                                                                           1.12179215]).reshape(
            (3, 1))),
        ...
        numpy.testing.assert_almost_equal(colour.computation.colourspaces.cie_lab.XYZ_to_Lab(numpy.matrix([1.92001986,
                                                                                                           1.,
                                                                                                           -0.1241347]).reshape(
            (3, 1))),
        ...
        numpy.testing.assert_almost_equal(colour.computation.colourspaces.cie_lab.XYZ_to_Lab(numpy.matrix([1.0131677,
                                                                                                           1.,
                                                                                                           2.11217686]).reshape(
            (3, 1))),
...
class TestLab_to_XYZ(unittest.TestCase):
    ...
    def test_Lab_to_XYZ(self):
        ...
        numpy.testing.assert_almost_equal(colour.computation.colourspaces.cie_lab.Lab_to_XYZ(numpy.matrix([100.,
                                                                                                           0.83871284,
                                                                                                           -21.55579303]).reshape(
            (3, 1))),
...
class TestLab_to_LCHab(unittest.TestCase):
    ...
    def test_Lab_to_LCHab(self):
        ...
        numpy.testing.assert_almost_equal(colour.computation.colourspaces.cie_lab.Lab_to_LCHab(numpy.matrix([100.,
                                                                                                             0.83871284,
                                                                                                             -21.55579303]).reshape(
            (3, 1))),
...
class TestLCHab_to_Lab(unittest.TestCase):
    ...
    def test_LCHab_to_Lab(self):
        ...
        numpy.testing.assert_almost_equal(colour.computation.colourspaces.cie_lab.LCHab_to_Lab(numpy.matrix([100.,
                                                                                                             21.57210357,
                                                                                                             272.2281935]).reshape(
            (3, 1))),
                                          numpy.matrix([100.,
