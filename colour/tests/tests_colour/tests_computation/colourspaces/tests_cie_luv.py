...
**Description:**
    Defines units tests for :mod:`colour.computation.colourspaces.cie_luv` module.
...
class TestXYZ_to_Luv(unittest.TestCase):
    """
    Defines :func:`colour.computation.colourspaces.cie_luv.XYZ_to_Luv` definition units tests methods.
    """
...
class TestLuv_to_XYZ(unittest.TestCase):
    """
    Defines :func:`colour.computation.colourspaces.cie_luv.Luv_to_XYZ` definition units tests methods.
    """
...
class TestLuv_to_uv(unittest.TestCase):
    """
    Defines :func:`colour.computation.colourspaces.cie_luv.Luv_to_uv` definition units tests methods.
    """
...
class TestLuv_to_LCHuv(unittest.TestCase):
    """
    Defines :func:`colour.computation.colourspaces.cie_luv.Luv_to_LCHuv` definition units tests methods.
    """
...
class TestLCHuv_to_Luv(unittest.TestCase):
    """
    Defines :func:`colour.computation.colourspaces.cie_luv.LCHuv_to_Luv` definition units tests methods.
    """
...
class TestLuv_uv_to_xy(unittest.TestCase):
    """
    Defines :func:`colour.computation.colourspaces.cie_luv.Luv_uv_to_xy` definition units tests methods.
    """

    def test_Luv_uv_to_xy(self):
        """
        Tests :func:`colour.computation.colourspaces.cie_luv.Luv_uv_to_xy` definition.
        """

        numpy.testing.assert_almost_equal(
            colour.computation.colourspaces.cie_luv.Luv_uv_to_xy((0.20048615433157738, 0.4654903849082484)),
