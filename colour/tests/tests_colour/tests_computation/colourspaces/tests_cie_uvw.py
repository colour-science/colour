...
class TestXYZ_to_UVW(unittest.TestCase):
    ...
    def test_XYZ_to_UVW(self):
        ...
        numpy.testing.assert_almost_equal(colour.computation.colourspaces.cie_uvw.XYZ_to_UVW(numpy.matrix([0.96907232,
                                                                                                           1.,
                                                                                                           1.12179215]).reshape(
            (3, 1))),
        ...
        numpy.testing.assert_almost_equal(colour.computation.colourspaces.cie_uvw.XYZ_to_UVW(numpy.matrix([1.92001986,
                                                                                                           1.,
                                                                                                           -0.1241347]).reshape(
            (3, 1))),
        ...
        numpy.testing.assert_almost_equal(colour.computation.colourspaces.cie_uvw.XYZ_to_UVW(numpy.matrix([1.0131677,
                                                                                                           1.,
                                                                                                           2.11217686]).reshape(
            (3, 1))),
