...
class TestXYZ_to_xyY(unittest.TestCase):
    ...
    def test_XYZ_to_xyY(self):
        ...
        numpy.testing.assert_almost_equal(
            colour.computation.colourspaces.cie_xyy.XYZ_to_xyY(numpy.matrix([3.08690042, 3.2, 2.68925666]).reshape((3, 1))),
            numpy.matrix([0.3439, 0.3565, 3.20]).reshape((3, 1)),
            decimal=7)

        numpy.testing.assert_almost_equal(
            colour.computation.colourspaces.cie_xyy.XYZ_to_xyY(numpy.matrix([0, 0, 0]).reshape((3, 1)), (0.34567, 0.35850)),
...
class TestxyY_to_XYZ(unittest.TestCase):
    ...
    def test_xyY_to_XYZ(self):
        ...
        numpy.testing.assert_almost_equal(
            colour.computation.colourspaces.cie_xyy.xyY_to_XYZ(numpy.matrix([0.4325, 0.3788, 10.34]).reshape((3, 1))),
        ...
        numpy.testing.assert_almost_equal(
            colour.computation.colourspaces.cie_xyy.xyY_to_XYZ(numpy.matrix([0.3439, 0.3565, 3.20]).reshape((3, 1))),
        ...
        numpy.testing.assert_almost_equal(
            colour.computation.colourspaces.cie_xyy.xyY_to_XYZ(numpy.matrix([0.4325, 0., 10.34]).reshape((3, 1))),
            numpy.matrix([0.,
                          0.,
                          0.]).reshape((3, 1)),
            decimal=7)
...
class Testxy_to_XYZ(unittest.TestCase):
    ...
    def test_xy_to_XYZ(self):
        ...
        numpy.testing.assert_almost_equal(
            colour.computation.colourspaces.cie_xyy.xy_to_XYZ((0.32207410281368043,
                                                          0.3315655001362353)),
        ...
        numpy.testing.assert_almost_equal(
            colour.computation.colourspaces.cie_xyy.xy_to_XYZ((0.32174206617150575,
                                                          0.337609723160027)),
            numpy.matrix([0.953,
                          1.000,
                          1.009]).reshape((3, 1)),
        ...
        numpy.testing.assert_almost_equal(
            colour.computation.colourspaces.cie_xyy.xy_to_XYZ((0.4474327628361859,
                                                          0.4074979625101875)),
            numpy.matrix([1.098,
                          1.000,
                          0.356]).reshape((3, 1)),
...
class TestXYZ_to_xy(unittest.TestCase):
    ...
    def test_XYZ_to_xy(self):
        ...
        numpy.testing.assert_almost_equal(colour.computation.colourspaces.cie_xyy.XYZ_to_xy((0.97137399,
                                                                                        1.,
                                                                                        1.04462134)),
                                          (0.32207410281368043, 0.3315655001362353),
                                          decimal=7)

        numpy.testing.assert_almost_equal(colour.computation.colourspaces.cie_xyy.XYZ_to_xy((0.953,
                                                                                        1.000,
                                                                                        1.009)),
                                          (0.32174206617150575, 0.337609723160027),
                                          decimal=7)

        numpy.testing.assert_almost_equal(colour.computation.colourspaces.cie_xyy.XYZ_to_xy((1.098,
                                                                                        1.000,
                                                                                        0.356)),
...
class TestXYZ_to_RGB(unittest.TestCase):
    ...
    def test_XYZ_to_RGB(self):
        ...
        for xyY, XYZ, RGB in sRGB_LINEAR_COLORCHECKER_2005:
            numpy.testing.assert_almost_equal(
                colour.computation.colourspaces.cie_xyy.XYZ_to_RGB(numpy.matrix(XYZ).reshape((3, 1)),
                                                              (0.34567, 0.35850),
                                                              (0.31271, 0.32902),
                                                              "Bradford",
                                                              numpy.matrix(
...
class TestRGB_to_XYZ(unittest.TestCase):
    ...
    def test_RGB_to_XYZ(self):
        ...
        for xyY, XYZ, RGB in sRGB_LINEAR_COLORCHECKER_2005:
            numpy.testing.assert_almost_equal(colour.computation.colourspaces.cie_xyy.RGB_to_XYZ(RGB,
                                                                                            (0.31271, 0.32902),
                                                                                            (0.34567, 0.35850),
                                                                                            "Bradford",
                                                                                            numpy.matrix(
...
class TestxyY_to_RGB(unittest.TestCase):
    ...
    def test_xyY_to_RGB(self):
        ...
        for xyY, XYZ, RGB in sRGB_LINEAR_COLORCHECKER_2005:
            numpy.testing.assert_almost_equal(
                colour.computation.colourspaces.cie_xyy.xyY_to_RGB(numpy.matrix(xyY).reshape((3, 1)),
                                                              (0.34567, 0.35850),
                                                              (0.31271, 0.32902),
                                                              "Bradford",
                                                              numpy.matrix(
...
class TestRGB_to_xyY(unittest.TestCase):
    ...
    def test_RGB_to_xyY(self):
        ...
        for xyY, XYZ, RGB in sRGB_LINEAR_COLORCHECKER_2005:
            numpy.testing.assert_almost_equal(colour.computation.colourspaces.cie_xyy.RGB_to_xyY(RGB,
                                                                                            (0.31271, 0.32902),
                                                                                            (0.34567, 0.35850),
                                                                                            "Bradford",
                                                                                            numpy.matrix(
