...
class TestXYZ_to_RGB(unittest.TestCase):
    """
    Defines :func:`colour.computation.colourspaces.cie_xyy.XYZ_to_RGB` definition units tests methods.
    """

    def test_XYZ_to_RGB(self):
        """
        Tests :func:`colour.computation.colourspaces.cie_xyy.XYZ_to_RGB` definition.
        """

        for xyY, XYZ, RGB in sRGB_LINEAR_COLORCHECKER_2005:
            numpy.testing.assert_almost_equal(
                colour.computation.colourspaces.cie_xyy.XYZ_to_RGB(
...
class TestRGB_to_XYZ(unittest.TestCase):
    """
    Defines :func:`colour.computation.colourspaces.cie_xyy.RGB_to_XYZ` definition units tests methods.
    """

    def test_RGB_to_XYZ(self):
        """
        Tests :func:`colour.computation.colourspaces.cie_xyy.RGB_to_XYZ` definition.
        """

        for xyY, XYZ, RGB in sRGB_LINEAR_COLORCHECKER_2005:
            numpy.testing.assert_almost_equal(
                colour.computation.colourspaces.cie_xyy.RGB_to_XYZ(
                    RGB,
                    (0.31271, 0.32902),
                    (0.34567, 0.35850),
                    "Bradford",
...
class TestxyY_to_RGB(unittest.TestCase):
    """
    Defines :func:`colour.computation.colourspaces.cie_xyy.xyY_to_RGB` definition units tests methods.
    """

    def test_xyY_to_RGB(self):
        """
        Tests :func:`colour.computation.colourspaces.cie_xyy.xyY_to_RGB` definition.
        """

        for xyY, XYZ, RGB in sRGB_LINEAR_COLORCHECKER_2005:
            numpy.testing.assert_almost_equal(
                colour.computation.colourspaces.cie_xyy.xyY_to_RGB(
...
class TestRGB_to_xyY(unittest.TestCase):
    """
    Defines :func:`colour.computation.colourspaces.cie_xyy.RGB_to_xyY` definition units tests methods.
    """

    def test_RGB_to_xyY(self):
        """
        Tests :func:`colour.computation.colourspaces.cie_xyy.RGB_to_xyY` definition.
        """

        for xyY, XYZ, RGB in sRGB_LINEAR_COLORCHECKER_2005:
            numpy.testing.assert_almost_equal(
                colour.computation.colourspaces.cie_xyy.RGB_to_xyY(
                    RGB,
                    (0.31271, 0.32902),
                    (0.34567, 0.35850),
                    "Bradford",
