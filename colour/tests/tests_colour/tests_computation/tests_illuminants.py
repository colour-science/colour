...
**Description:**
    Defines units tests for :mod:`colour.computation.illuminants` module.
...
class TestD_illuminantRelativeSpd(unittest.TestCase):
    """
    Defines :func:`colour.computation.illuminants.D_illuminant_relative_spd` definition units tests methods.
    """

    def test_D_illuminant_relative_spd(self):
        """
        Tests :func:`colour.computation.illuminants.D_illuminant_relative_spd` definition.
        """

        numpy.testing.assert_almost_equal(
            sorted(colour.computation.illuminants.D_illuminant_relative_spd(
