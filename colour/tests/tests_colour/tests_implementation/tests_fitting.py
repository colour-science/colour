...
**Description:**
    Defines units tests for :mod:`colour.implementation.fitting` package.
...
class TestFirstOrderColourFit(unittest.TestCase):
    """
    Defines :func:`colour.implementation.fitting.first_order_colour_fit` definition units tests methods.
    """
