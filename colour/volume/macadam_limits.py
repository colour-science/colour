...
def macadam_limits(
    ...
    illuminant: SDS_ILLUMINANTS = SDS_ILLUMINANTS["E"],
    spectral_range: SpectralShape = SpectralShape(360, 830, 1),
    cmfs: MSDS_CMFS = MSDS_CMFS["CIE 1931 2 Degree Standard Observer"],
) -> NDArray:
    """
